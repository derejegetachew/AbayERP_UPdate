...
,			['FmsIncident.occurrence_date', '<?php __('Occurrence Date'); ?>']
,			['FmsIncident.occurrence_time', '<?php __('Occurrence Time'); ?>']
,			['FmsIncident.occurrence_place', '<?php __('Occurrence Place'); ?>']
,			['FmsIncident.details', '<?php __('Details'); ?>']
,			['FmsIncident.action_taken', '<?php __('Action Taken'); ?>']
,			['FmsIncident.created_by', '<?php __('Created By'); ?>']
,			['FmsIncident.created', '<?php __('Created'); ?>']
,			['FmsIncident.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsIncidentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var fmsIncidentSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsIncident'); ?>',
	modal: true,
	items: fmsIncidentSearchForm,
	resizable: false,
	width: 550,
	height: 400,

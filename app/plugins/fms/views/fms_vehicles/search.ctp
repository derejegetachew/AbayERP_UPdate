...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['FmsVehicle.vehicle_type', '<?php __('Vehicle Type'); ?>']
,			['FmsVehicle.plate_no', '<?php __('Plate No'); ?>']
,			['FmsVehicle.model', '<?php __('Model'); ?>']
,			['FmsVehicle.engine_no', '<?php __('Engine No'); ?>']
,			['FmsVehicle.chassis_no', '<?php __('Chassis No'); ?>']
,			['FmsVehicle.fuel_type', '<?php __('Fuel Type'); ?>']
,			['FmsVehicle.no_of_tyre', '<?php __('No Of Tyre'); ?>']
,			['FmsVehicle.horsepower', '<?php __('Horsepower'); ?>']
,			['FmsVehicle.carload_people', '<?php __('Carload People'); ?>']
,			['FmsVehicle.carload_goods', '<?php __('Carload Goods'); ?>']
,			['FmsVehicle.purchase_amount', '<?php __('Purchase Amount'); ?>']
,			['FmsVehicle.purchase_date', '<?php __('Purchase Date'); ?>']
,			['FmsVehicle.remark', '<?php __('Remark'); ?>']
,			['FmsVehicle.created_by', '<?php __('Created By'); ?>']
,			['FmsVehicle.created', '<?php __('Created'); ?>']
,			['FmsVehicle.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsVehicleSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var fmsVehicleSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsVehicle'); ?>',
	modal: true,
	items: fmsVehicleSearchForm,
	resizable: false,
	width: 550,
	height: 400,

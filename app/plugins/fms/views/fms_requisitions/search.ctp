...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['FmsRequisition.name', '<?php __('Name'); ?>']
,			['FmsRequisition.requested_by', '<?php __('Requested By'); ?>']
,			['FmsRequisition.approved_by', '<?php __('Approved By'); ?>']
,			['Branch.name', '<?php __('Branch'); ?>']
,			['FmsRequisition.town', '<?php __('Town'); ?>']
,			['FmsRequisition.place', '<?php __('Place'); ?>']
,			['FmsRequisition.departure_date', '<?php __('Departure Date'); ?>']
,			['FmsRequisition.arrival_date', '<?php __('Arrival Date'); ?>']
,			['FmsRequisition.departure_time', '<?php __('Departure Time'); ?>']
,			['FmsRequisition.arrival_time', '<?php __('Arrival Time'); ?>']
,			['FmsRequisition.travelers', '<?php __('Travelers'); ?>']
,			['FmsVehicle.name', '<?php __('FmsVehicle'); ?>']
,			['FmsRequisition.start_odometer', '<?php __('Start Odometer'); ?>']
,			['FmsRequisition.end_odometer', '<?php __('End Odometer'); ?>']
,			['FmsRequisition.transport_clerk', '<?php __('Transport Clerk'); ?>']
,			['FmsRequisition.transport_supervisor', '<?php __('Transport Supervisor'); ?>']
,			['FmsRequisition.created', '<?php __('Created'); ?>']
,			['FmsRequisition.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsRequisitionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					fmsRequisitionSearchWindow.close();
...
var fmsRequisitionSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsRequisition'); ?>',
	modal: true,
	items: fmsRequisitionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
,			['FmsMaintenance.item', '<?php __('Item'); ?>']
,			['FmsMaintenance.serial', '<?php __('Serial'); ?>']
,			['FmsMaintenance.measurement', '<?php __('Measurement'); ?>']
,			['FmsMaintenance.quantity', '<?php __('Quantity'); ?>']
,			['FmsMaintenance.unit_price', '<?php __('Unit Price'); ?>']
,			['FmsMaintenance.status', '<?php __('Status'); ?>']
,			['FmsMaintenance.created_by', '<?php __('Created By'); ?>']
,			['FmsMaintenance.approved_by', '<?php __('Approved By'); ?>']
,			['FmsMaintenance.created', '<?php __('Created'); ?>']
,			['FmsMaintenance.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsMaintenanceSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					fmsMaintenanceSearchWindow.close();
...
var fmsMaintenanceSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsMaintenance'); ?>',
	modal: true,
	items: fmsMaintenanceSearchForm,
	resizable: false,
	width: 550,
	height: 400,

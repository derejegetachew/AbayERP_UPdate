...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['FmsDriver.name', '<?php __('FmsDriver'); ?>']
,			['FmsVehicle.name', '<?php __('FmsVehicle'); ?>']
,			['FmsDrivertovehicleAssignment.start_date', '<?php __('Start Date'); ?>']
,			['FmsDrivertovehicleAssignment.end_date', '<?php __('End Date'); ?>']
,			['FmsDrivertovehicleAssignment.created_by', '<?php __('Created By'); ?>']
,			['FmsDrivertovehicleAssignment.created', '<?php __('Created'); ?>']
,			['FmsDrivertovehicleAssignment.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsDrivertovehicleAssignmentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					fmsDrivertovehicleAssignmentSearchWindow.close();
...
var fmsDrivertovehicleAssignmentSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsDrivertovehicleAssignment'); ?>',
	modal: true,
	items: fmsDrivertovehicleAssignmentSearchForm,
	resizable: false,
	width: 550,
	height: 400,

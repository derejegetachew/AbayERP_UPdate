...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Person.name', '<?php __('Person'); ?>']
,			['FmsDriver.license_no', '<?php __('License No'); ?>']
,			['FmsDriver.date_given', '<?php __('Date Given'); ?>']
,			['FmsDriver.expiration_date', '<?php __('Expiration Date'); ?>']
,			['FmsDriver.created_by', '<?php __('Created By'); ?>']
,			['FmsDriver.created', '<?php __('Created'); ?>']
,			['FmsDriver.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsDriverSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var fmsDriverSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsDriver'); ?>',
	modal: true,
	items: fmsDriverSearchForm,
	resizable: false,
	width: 550,
	height: 400,

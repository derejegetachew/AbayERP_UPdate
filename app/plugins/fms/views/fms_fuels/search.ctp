...
,			['FmsFuel.fueled_day', '<?php __('Fueled Day'); ?>']
,			['FmsFuel.litre', '<?php __('Litre'); ?>']
,			['FmsFuel.price', '<?php __('Price'); ?>']
,			['FmsFuel.kilometer', '<?php __('Kilometer'); ?>']
,			['FmsFuel.status', '<?php __('Status'); ?>']
,			['FmsFuel.created_by', '<?php __('Created By'); ?>']
,			['FmsFuel.approved_by', '<?php __('Approved By'); ?>']
,			['FmsFuel.created', '<?php __('Created'); ?>']
,			['FmsFuel.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsFuelSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var fmsFuelSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsFuel'); ?>',
	modal: true,
	items: fmsFuelSearchForm,
	resizable: false,
	width: 550,
	height: 400,

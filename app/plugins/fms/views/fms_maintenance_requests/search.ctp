...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['FmsMaintenanceRequest.company', '<?php __('Company'); ?>']
,			['FmsVehicle.name', '<?php __('FmsVehicle'); ?>']
,			['FmsMaintenanceRequest.km', '<?php __('Km'); ?>']
,			['FmsMaintenanceRequest.damage_type', '<?php __('Damage Type'); ?>']
,			['FmsMaintenanceRequest.examination', '<?php __('Examination'); ?>']
,			['FmsMaintenanceRequest.notifier', '<?php __('Notifier'); ?>']
,			['FmsMaintenanceRequest.confirmer', '<?php __('Confirmer'); ?>']
,			['FmsMaintenanceRequest.approver', '<?php __('Approver'); ?>']
,			['FmsMaintenanceRequest.created', '<?php __('Created'); ?>']
,			['FmsMaintenanceRequest.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var fmsMaintenanceRequestSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					fmsMaintenanceRequestSearchWindow.close();
...
var fmsMaintenanceRequestSearchWindow = new Ext.Window({
	title: '<?php __('Search FmsMaintenanceRequest'); ?>',
	modal: true,
	items: fmsMaintenanceRequestSearchForm,
	resizable: false,
	width: 550,
	height: 400,

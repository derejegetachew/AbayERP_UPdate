...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['MisLetter.name', '<?php __('MisLetter'); ?>']
,			['MisLetterDetail.type', '<?php __('Type'); ?>']
,			['MisLetterDetail.account_of', '<?php __('Account Of'); ?>']
,			['MisLetterDetail.account_number', '<?php __('Account Number'); ?>']
,			['MisLetterDetail.amount', '<?php __('Amount'); ?>']
,			['Branch.name', '<?php __('Branch'); ?>']
,			['MisLetterDetail.status', '<?php __('Status'); ?>']
,			['MisLetterDetail.created_by', '<?php __('Created By'); ?>']
,			['MisLetterDetail.replied_by', '<?php __('Replied By'); ?>']
,			['MisLetterDetail.completed_by', '<?php __('Completed By'); ?>']
,			['MisLetterDetail.letter_prepared_by', '<?php __('Letter Prepared By'); ?>']
,			['MisLetterDetail.remark', '<?php __('Remark'); ?>']
,			['MisLetterDetail.file', '<?php __('File'); ?>']
,			['MisLetterDetail.created', '<?php __('Created'); ?>']
,			['MisLetterDetail.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var misLetterDetailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					misLetterDetailSearchWindow.close();
...
var misLetterDetailSearchWindow = new Ext.Window({
	title: '<?php __('Search MisLetterDetail'); ?>',
	modal: true,
	items: misLetterDetailSearchForm,
	resizable: false,
	width: 550,
	height: 400,

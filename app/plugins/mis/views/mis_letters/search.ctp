...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['MisLetter.ref_no', '<?php __('Ref No'); ?>']
,			['MisLetter.applicant', '<?php __('Applicant'); ?>']
,			['MisLetter.defendant', '<?php __('Defendant'); ?>']
,			['MisLetter.letter_no', '<?php __('Letter No'); ?>']
,			['MisLetter.date', '<?php __('Date'); ?>']
,			['MisLetter.deadline', '<?php __('Deadline'); ?>']
,			['MisLetter.source', '<?php __('Source'); ?>']
,			['MisLetter.office', '<?php __('Office'); ?>']
,			['MisLetter.messenger', '<?php __('Messenger'); ?>']
,			['MisLetter.file', '<?php __('File'); ?>']
,			['MisLetter.status', '<?php __('Status'); ?>']
,			['MisLetter.created_by', '<?php __('Created By'); ?>']
,			['MisLetter.created', '<?php __('Created'); ?>']
,			['MisLetter.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var misLetterSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var misLetterSearchWindow = new Ext.Window({
	title: '<?php __('Search MisLetter'); ?>',
	modal: true,
	items: misLetterSearchForm,
	resizable: false,
	width: 550,
	height: 400,

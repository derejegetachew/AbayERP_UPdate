...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['CmsGroup.name', '<?php __('Name'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['CmsGroup.created', '<?php __('Created'); ?>']
,			['CmsGroup.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var cmsGroupSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var cmsGroupSearchWindow = new Ext.Window({
	title: '<?php __('Search CmsGroup'); ?>',
	modal: true,
	items: cmsGroupSearchForm,
	resizable: false,
	width: 550,
	height: 400,

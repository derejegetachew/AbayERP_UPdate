...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['CmsReply.content', '<?php __('Content'); ?>']
,			['CmsCase.name', '<?php __('CmsCase'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['CmsReply.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var cmsReplySearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var cmsReplySearchWindow = new Ext.Window({
	title: '<?php __('Search CmsReply'); ?>',
	modal: true,
	items: cmsReplySearchForm,
	resizable: false,
	width: 550,
	height: 400,

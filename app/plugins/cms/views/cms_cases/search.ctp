...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['CmsCase.name', '<?php __('Name'); ?>']
,			['CmsCase.content', '<?php __('Content'); ?>']
,			['Branch.name', '<?php __('Branch'); ?>']
,			['CmsCase.level', '<?php __('Level'); ?>']
,			['CmsCase.attachement', '<?php __('Attachement'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['CmsCase.status', '<?php __('Status'); ?>']
,			['CmsCase.searchable', '<?php __('Searchable'); ?>']
,			['CmsCase.created', '<?php __('Created'); ?>']
,			['CmsCase.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var cmsCaseSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var cmsCaseSearchWindow = new Ext.Window({
	title: '<?php __('Search CmsCase'); ?>',
	modal: true,
	items: cmsCaseSearchForm,
	resizable: false,
	width: 550,
	height: 400,

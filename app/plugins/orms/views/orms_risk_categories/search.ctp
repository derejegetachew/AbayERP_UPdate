...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['OrmsRiskCategory.name', '<?php __('Name'); ?>']
,			['ParentOrmsRiskCategory.name', '<?php __('ParentOrmsRiskCategory'); ?>']
,			['OrmsRiskCategory.lft', '<?php __('Lft'); ?>']
,			['OrmsRiskCategory.rght', '<?php __('Rght'); ?>']
,			['OrmsRiskCategory.created', '<?php __('Created'); ?>']
,			['OrmsRiskCategory.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var ormsRiskCategorySearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					ormsRiskCategorySearchWindow.close();
...
var ormsRiskCategorySearchWindow = new Ext.Window({
	title: '<?php __('Search OrmsRiskCategory'); ?>',
	modal: true,
	items: ormsRiskCategorySearchForm,
	resizable: false,
	width: 550,
	height: 400,

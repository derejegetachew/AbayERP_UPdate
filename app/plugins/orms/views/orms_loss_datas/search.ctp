...
,			['OrmsRiskCategory.name', '<?php __('OrmsRiskCategory'); ?>']
,			['OrmsLossData.created_by', '<?php __('Created By'); ?>']
,			['OrmsLossData.approved_by', '<?php __('Approved By'); ?>']
,			['OrmsLossData.occured_from', '<?php __('Occured From'); ?>']
,			['OrmsLossData.occured_to', '<?php __('Occured To'); ?>']
,			['OrmsLossData.discovered_date', '<?php __('Discovered Date'); ?>']
,			['OrmsLossData.event', '<?php __('Event'); ?>']
,			['OrmsLossData.description', '<?php __('Description'); ?>']
,			['OrmsLossData.created', '<?php __('Created'); ?>']
,			['OrmsLossData.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var ormsLossDataSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					ormsLossDataSearchWindow.close();
...
var ormsLossDataSearchWindow = new Ext.Window({
	title: '<?php __('Search OrmsLossData'); ?>',
	modal: true,
	items: ormsLossDataSearchForm,
	resizable: false,
	width: 550,
	height: 400,

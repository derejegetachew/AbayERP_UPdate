//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_item_categories', 'action' => 'list_data', $parent_id)); ?>'	})
    });


    function AddParentItemCategory() {
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_item_categories', 'action' => 'add', $parent_id)); ?>',
	...
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'ims_item_categories', 'action' => 'edit')); ?>/'+id+'/<?php echo $parent_id; ?>',
		success: function(response, opts) {
			var parent_itemCategory_data = response.responseText;
...
function ViewItemCategory(id) {
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'ims_item_categories', 'action' => 'view')); ?>/'+id,
		success: function(response, opts) {
...
function ViewItemCategoryItemCategories(id) {
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'ims_item_categories', 'action' => 'index2')); ?>/'+id,
		success: function(response, opts) {

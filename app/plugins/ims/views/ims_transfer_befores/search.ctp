...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsTransferBefore.name', '<?php __('Name'); ?>']
,			['ImsSirvBefore.name', '<?php __('ImsSirvBefore'); ?>']
,			['ImsTransferBefore.from_user', '<?php __('From User'); ?>']
,			['ImsTransferBefore.to_user', '<?php __('To User'); ?>']
,			['ImsTransferBefore.from_branch', '<?php __('From Branch'); ?>']
,			['ImsTransferBefore.to_branch', '<?php __('To Branch'); ?>']
,			['ImsTransferBefore.observer', '<?php __('Observer'); ?>']
,			['ImsTransferBefore.approved_by', '<?php __('Approved By'); ?>']
,			['ImsTransferBefore.created', '<?php __('Created'); ?>']
,			['ImsTransferBefore.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsTransferBeforeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsTransferBeforeSearchWindow.close();
...
var imsTransferBeforeSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsTransferBefore'); ?>',
	modal: true,
	items: imsTransferBeforeSearchForm,
	resizable: false,
	width: 550,
	height: 400,

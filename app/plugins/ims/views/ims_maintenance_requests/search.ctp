...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsMaintenanceRequest.name', '<?php __('Name'); ?>']
,			['Branch.name', '<?php __('Branch'); ?>']
,			['ImsMaintenanceRequest.description', '<?php __('Description'); ?>']
,			['ImsMaintenanceRequest.requested_by', '<?php __('Requested By'); ?>']
,			['ImsMaintenanceRequest.approved_rejected_by', '<?php __('Approved Rejected By'); ?>']
,			['ImsMaintenanceRequest.status', '<?php __('Status'); ?>']
,			['ImsItem.name', '<?php __('ImsItem'); ?>']
,			['ImsMaintenanceRequest.tag', '<?php __('Tag'); ?>']
,			['ImsMaintenanceRequest.branch_recommendation', '<?php __('Branch Recommendation'); ?>']
,			['ImsMaintenanceRequest.technician_recommendation', '<?php __('Technician Recommendation'); ?>']
,			['ImsMaintenanceRequest.remark', '<?php __('Remark'); ?>']
,			['ImsMaintenanceRequest.created', '<?php __('Created'); ?>']
,			['ImsMaintenanceRequest.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsMaintenanceRequestSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsMaintenanceRequestSearchWindow.close();
...
var imsMaintenanceRequestSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsMaintenanceRequest'); ?>',
	modal: true,
	items: imsMaintenanceRequestSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
,			['ImsRent.width', '<?php __('Width'); ?>']
,			['ImsRent.monthly_rent', '<?php __('Monthly Rent'); ?>']
,			['ImsRent.contract_signed_date', '<?php __('Contract Signed Date'); ?>']
,			['ImsRent.contract_age', '<?php __('Contract Age'); ?>']
,			['ImsRent.contract_functional_date', '<?php __('Contract Functional Date'); ?>']
,			['ImsRent.contract_end_date', '<?php __('Contract End Date'); ?>']
,			['ImsRent.prepayed_amount', '<?php __('Prepayed Amount'); ?>']
,			['ImsRent.prepayed_end_date', '<?php __('Prepayed End Date'); ?>']
,			['ImsRent.created_by', '<?php __('Created By'); ?>']
,			['ImsRent.renter', '<?php __('Renter name'); ?>']
,			['ImsRent.address', '<?php __('Renter address'); ?>']
,			['ImsRent.created', '<?php __('Created'); ?>']
,			['ImsRent.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsRentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsRentSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsRent'); ?>',
	modal: true,
	items: imsRentSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsDisposal.name', '<?php __('ImsDisposal'); ?>']
,			['ImsItem.name', '<?php __('ImsItem'); ?>']
,			['ImsDisposalItem.measurement', '<?php __('Measurement'); ?>']
,			['ImsDisposalItem.quantity', '<?php __('Quantity'); ?>']
,			['ImsDisposalItem.remark', '<?php __('Remark'); ?>']
,			['ImsDisposalItem.created', '<?php __('Created'); ?>']
,			['ImsDisposalItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsDisposalItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsDisposalItemSearchWindow.close();
...
var imsDisposalItemSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsDisposalItem'); ?>',
	modal: true,
	items: imsDisposalItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

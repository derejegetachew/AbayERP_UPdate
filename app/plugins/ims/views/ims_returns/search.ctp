...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsReturn.name', '<?php __('Name'); ?>']
,			['ImsReturn.received_by', '<?php __('Received By'); ?>']
,			['ImsReturn.created', '<?php __('Created'); ?>']
,			['ImsReturn.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsReturnSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsReturnSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsReturn'); ?>',
	modal: true,
	items: imsReturnSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsSupplier.name', '<?php __('Name'); ?>']
,			['ImsSupplier.address', '<?php __('Address'); ?>']
,			['ImsSupplier.tin', '<?php __('TIN Number'); ?>']
,			['ImsSupplier.created', '<?php __('Created'); ?>']
,			['ImsSupplier.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',

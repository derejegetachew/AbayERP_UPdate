...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsTransferBefore.name', '<?php __('ImsTransferBefore'); ?>']
,			['ImsSirvItemBefore.name', '<?php __('ImsSirvItemBefore'); ?>']
,			['ImsItem.name', '<?php __('ImsItem'); ?>']
,			['ImsTransferItemBefore.measurement', '<?php __('Measurement'); ?>']
,			['ImsTransferItemBefore.quantity', '<?php __('Quantity'); ?>']
,			['ImsTransferItemBefore.unit_price', '<?php __('Unit Price'); ?>']
,			['ImsTransferItemBefore.tag', '<?php __('Tag'); ?>']
,			['ImsTransferItemBefore.created', '<?php __('Created'); ?>']
,			['ImsTransferItemBefore.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsTransferItemBeforeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsTransferItemBeforeSearchWindow.close();
...
var imsTransferItemBeforeSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsTransferItemBefore'); ?>',
	modal: true,
	items: imsTransferItemBeforeSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsRequisition.name', '<?php __('Name'); ?>']
,			['BudgetYear.name', '<?php __('BudgetYear'); ?>']
,			['Branch.name', '<?php __('Branch'); ?>']
,			['ImsRequisition.purpose', '<?php __('Purpose'); ?>']
,			['ImsRequisition.requested_by', '<?php __('Requested By'); ?>']
,			['ImsRequisition.posted', '<?php __('Posted'); ?>']
,			['ImsRequisition.approved_by', '<?php __('Approved By'); ?>']
,			['ImsRequisition.created', '<?php __('Created'); ?>']
,			['ImsRequisition.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsRequisitionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsRequisitionSearchWindow.close();
...
var imsRequisitionSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsRequisition'); ?>',
	modal: true,
	items: imsRequisitionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

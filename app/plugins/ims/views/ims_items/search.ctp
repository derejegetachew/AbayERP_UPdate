//<script>
	...
	store: new Ext.data.ArrayStore({
            ...
            data: [
                ['ImsItem.name', '<?php __('Name'); ?>'],
                ['ImsItem.description', '<?php __('Description'); ?>'],
                ['ImsItemCategory.name', '<?php __('ItemCategory'); ?>'],
                ['ImsItem.created', '<?php __('Created'); ?>'],
                ['ImsItem.modified', '<?php __('Modified'); ?>']
            ]
	}),
	mode: 'local',
    ...
    var itemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
    ...
    var itemSearchWindow = new Ext.Window({
	title: '<?php __('Search Item'); ?>',
	modal: true,
	items: itemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

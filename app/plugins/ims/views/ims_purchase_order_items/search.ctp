//<script>
	...
	store: new Ext.data.ArrayStore({
            ...
            data: [
                ['ImsPurchaseOrder.name', '<?php __('PurchaseOrder'); ?>'],
                ['ImsItem.name', '<?php __('Item'); ?>'],
                ['ImsPurchaseOrderItem.measurement', '<?php __('Measurement'); ?>'],
                ['ImsPurchaseOrderItem.ordered_quantity', '<?php __('Ordered Quantity'); ?>'],
                ['ImsPurchaseOrderItem.purchased_quantity', '<?php __('Purchased Quantity'); ?>'],
                ['ImsPurchaseOrderItem.unit_price', '<?php __('Unit Price'); ?>'],
                ['ImsPurchaseOrderItem.created', '<?php __('Created'); ?>'],
                ['ImsPurchaseOrderItem.modified', '<?php __('Modified'); ?>']
            ]
	}),
	mode: 'local',
    ...
    var purchaseOrderItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrderItems', 'action' => 'search')); ?>',
		...
		
            {
                ...
                handler: function(){
                    if(ParamStore.getCount() == 0)
                        ...
                        purchaseOrderItemSearchWindow.close();
    ...
    var purchaseOrderItemSearchWindow = new Ext.Window({
	title: '<?php __('Search PurchaseOrderItem'); ?>',
	modal: true,
	items: purchaseOrderItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

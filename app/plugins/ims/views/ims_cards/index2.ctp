//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_cards', 'action' => 'list_data', $parent_id)); ?>'	})
    });

    function AddParentCard() {
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_cards', 'action' => 'add', $parent_id)); ?>',
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_cards', 'action' => 'edit')); ?>/'+id+'/<?php echo $parent_id; ?>',
            success: function(response, opts) {
                var parent_card_data = response.responseText;

...
,			['ImsCard.name', '<?php __('ImsCard'); ?>']
,			['ImsStoresCard.created', '<?php __('Created'); ?>']
,			['ImsStoresCard.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsStoresCardSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsStoresCardSearchWindow.close();
...
var imsStoresCardSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsStoresCard'); ?>',
	modal: true,
	items: imsStoresCardSearchForm,
	resizable: false,
	width: 550,
	height: 400,

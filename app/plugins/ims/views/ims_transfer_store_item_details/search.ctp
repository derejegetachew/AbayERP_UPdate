...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsTransferStoreItem.name', '<?php __('Transfer Store Item'); ?>']
,			['ImsItem.name', '<?php __('Item'); ?>']
,			['ImsTransferStoreItemDetail.quantity', '<?php __('Quantity'); ?>']
,			['ImsTransferStoreItemDetail.measurement', '<?php __('Measurement'); ?>']
,			['ImsTransferStoreItemDetail.remark', '<?php __('Remark'); ?>']
,			['ImsTransferStoreItemDetail.created', '<?php __('Created'); ?>']
,			['ImsTransferStoreItemDetail.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsTransferStoreItemDetailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsTransferStoreItemDetailSearchWindow.close();
...
var imsTransferStoreItemDetailSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsTransferStoreItemDetail'); ?>',
	modal: true,
	items: imsTransferStoreItemDetailSearchForm,
	resizable: false,
	width: 550,
	height: 400,

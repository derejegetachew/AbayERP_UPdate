...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsBudget.name', '<?php __('Name'); ?>']
,			['BudgetYear.name', '<?php __('BudgetYear'); ?>']
,			['Branch.name', '<?php __('Branch'); ?>']
,			['ImsBudget.created', '<?php __('Created'); ?>']
,			['ImsBudget.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsBudgetSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsBudgetSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsBudget'); ?>',
	modal: true,
	items: imsBudgetSearchForm,
	resizable: false,
	width: 550,
	height: 400,

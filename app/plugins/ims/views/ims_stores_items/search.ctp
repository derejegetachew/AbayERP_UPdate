...
,			['ImsStoresItem.balance', '<?php __('Balance'); ?>']
,			['ImsStoresItem.created', '<?php __('Created'); ?>']
,			['ImsStoresItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsStoresItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsStoresItemSearchWindow.close();
...
var imsStoresItemSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsStoresItem'); ?>',
	modal: true,
	items: imsStoresItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsDisposal.name', '<?php __('Name'); ?>']
,			['ImsDisposal.status', '<?php __('Status'); ?>']
,			['ImsStore.name', '<?php __('ImsStore'); ?>']
,			['ImsDisposal.created_by', '<?php __('Created By'); ?>']
,			['ImsDisposal.modified_by', '<?php __('Modified By'); ?>']
,			['ImsDisposal.created', '<?php __('Created'); ?>']
,			['ImsDisposal.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsDisposalSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsDisposalSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsDisposal'); ?>',
	modal: true,
	items: imsDisposalSearchForm,
	resizable: false,
	width: 550,
	height: 400,

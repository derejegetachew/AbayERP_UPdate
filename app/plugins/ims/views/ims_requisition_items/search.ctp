...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsRequisition.name', '<?php __('ImsRequisition'); ?>']
,			['ImsItem.name', '<?php __('ImsItem'); ?>']
,			['ImsRequisitionItem.quantity', '<?php __('Quantity'); ?>']
,			['ImsRequisitionItem.measurement', '<?php __('Measurement'); ?>']
,			['ImsRequisitionItem.remark', '<?php __('Remark'); ?>']
,			['ImsRequisitionItem.created', '<?php __('Created'); ?>']
,			['ImsRequisitionItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsRequisitionItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsRequisitionItemSearchWindow.close();
...
var imsRequisitionItemSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsRequisitionItem'); ?>',
	modal: true,
	items: imsRequisitionItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

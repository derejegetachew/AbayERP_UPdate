...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsTag.code', '<?php __('Code'); ?>']
,			['ImsSirvItem.name', '<?php __('ImsSirvItem'); ?>']
,			['ImsSirvItemBefore.name', '<?php __('ImsSirvItemBefore'); ?>']
,			['ImsTag.created', '<?php __('Created'); ?>']
,			['ImsTag.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsTagSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsTagSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsTag'); ?>',
	modal: true,
	items: imsTagSearchForm,
	resizable: false,
	width: 550,
	height: 400,

//<script>
	...
	store: new Ext.data.ArrayStore({
            ...
            data: [
                ['ImsStore.name', '<?php __('Name'); ?>'],
                ['ImsStore.address', '<?php __('Address'); ?>'],
				['ImsStore.store_keeper_one', '<?php __('Store Keeper'); ?>'],
				['ImsStore.store_keeper_two', '<?php __('Store Keeper'); ?>'],
				['ImsStore.store_keeper_three', '<?php __('Store Keeper'); ?>'],
				['ImsStore.store_keeper_four', '<?php __('Store Keeper'); ?>'],
                ['ImsStore.created', '<?php __('Created'); ?>'],
                ['ImsStore.modified', '<?php __('Modified'); ?>']
            ]
	}),
	mode: 'local',
    ...
    var storeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
    ...
    var storeSearchWindow = new Ext.Window({
	title: '<?php __('Search Store'); ?>',
	modal: true,
	items: storeSearchForm,
	resizable: false,
	width: 550,
	height: 400,

//<script>
	...
	reader: new Ext.data.JsonReader({
            ...
            fields: [
                'id','name','address','store_keeper_one','store_keeper_two','store_keeper_three','store_keeper_four','created','modified'		
            ]
	}),
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_stores', 'action' => 'list_data')); ?>'
	}),	
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_stores', 'action' => 'edit')); ?>/'+id,
            success: function(response, opts) {
                var store_data = response.responseText;
    ...
    function ViewStore(id) {
        Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_stores', 'action' => 'view')); ?>/'+id,
            success: function(response, opts) {
                var store_data = response.responseText;
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_stores', 'action' => 'delete')); ?>/'+id,
            success: function(response, opts) {
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_stores', 'action' => 'search')); ?>',
            success: function(response, opts){
                var store_data = response.responseText;
	...
	var conditions = '\'ImsStore.name LIKE\' => \'%' + value + '%\'';
	store_stores.reload({
            params: {
                start: 0,
                limit: list_size,
	...
	var p = center_panel.add({
            ...
            columns: [
				...
				{header: "<?php __('Store Keeper One'); ?>", dataIndex: 'store_keeper_one', sortable: true},
				{header: "<?php __('Store Keeper Two'); ?>", dataIndex: 'store_keeper_two', sortable: true},
				{header: "<?php __('Store Keeper Three'); ?>", dataIndex: 'store_keeper_three', sortable: true},
				{header: "<?php __('Store Keeper Four'); ?>", dataIndex: 'store_keeper_four', sortable: true},

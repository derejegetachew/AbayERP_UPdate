...
var store_grnItems = new Ext.data.GroupingStore({
	...
	proxy: new Ext.data.HttpProxy({
		url: '<?php echo $this->Html->url(array('controller' => 'ims_grn_items', 'action' => 'list_data')); ?>'
	})
,	sortInfo:{field: 'ims_grn_id', direction: "ASC"},
	groupField: 'ims_purchase_order_item_id'
});
...
function EditGrnItem(id) {
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'ims_grn_items', 'action' => 'edit')); ?>/'+id,
		success: function(response, opts) {
			var grnItem_data = response.responseText;
...
function SearchGrnItem(){
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'ims_grn_items', 'action' => 'search')); ?>',
		success: function(response, opts){
			var grnItem_data = response.responseText;

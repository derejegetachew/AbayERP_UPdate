...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsGrn.name', '<?php __('Grn'); ?>']
,			['ImsPurchaseOrderItem.name', '<?php __('PurchaseOrderItem'); ?>']
,			['ImsGrnItem.quantity', '<?php __('Quantity'); ?>']
,			['ImsGrnItem.unit_price', '<?php __('Unit Price'); ?>']
,			['ImsGrnItem.created', '<?php __('Created'); ?>']
,			['ImsGrnItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var grnItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var grnItemSearchWindow = new Ext.Window({
	title: '<?php __('Search GrnItem'); ?>',
	modal: true,
	items: grnItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

//<script>
	...
	reader: new Ext.data.JsonReader({
            ...
            fields: ['id','ims_grn_id','item','ordered_quantity','purchased_quantity','ordered_unit_price','purchased_unit_price','remark']
        }),
        proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_grns', 'action' => 'list_data3', $grn_id)); ?>'
        })
    });
    ...
    var grn_items_grid_panel = new Ext.TabPanel({
        ...
        items:[{
            ...
            columns: [
                ...
                {header: "<?php __('Purchased Unit Price'); ?>", dataIndex: 'purchased_unit_price', sortable: true,renderer:  Ext.util.Format.numberRenderer('0000.0000'), editor: {  xtype: 'numberfield', allowBlank: false,decimalPrecision: 4 }, align:'right'},
                {header: "<?php __('Remark'); ?>", dataIndex: 'remark', sortable: true, editor: {  xtype: 'textfield', allowBlank: true}, align:'left'}
            ],
            viewConfig: {
                forceFit: true
            },

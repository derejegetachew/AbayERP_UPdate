...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsGrn.name', '<?php __('Name'); ?>']
,			['ImsSupplier.name', '<?php __('Supplier'); ?>']
,			['ImsPurchaseOrder.name', '<?php __('PurchaseOrder'); ?>']
,			['ImsGrn.date_purchased', '<?php __('Date Purchased'); ?>']
,			['ImsGrn.created', '<?php __('Created'); ?>']
,			['ImsGrn.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var grnSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var grnSearchWindow = new Ext.Window({
	title: '<?php __('Search Grn'); ?>',
	modal: true,
	items: grnSearchForm,
	resizable: false,
	width: 550,

...
,			['ImsDelegate.name', '<?php __('Name'); ?>']
,			['ImsDelegate.phone', '<?php __('Phone'); ?>']
,			['ImsDelegate.created', '<?php __('Created'); ?>']
,			['ImsDelegate.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsDelegateSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsDelegateSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsDelegate'); ?>',
	modal: true,
	items: imsDelegateSearchForm,
	resizable: false,
	width: 550,
	height: 400,

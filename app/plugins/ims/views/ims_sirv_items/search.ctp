...
,			['ImsSirvItem.measurement', '<?php __('Measurement'); ?>']
,			['ImsSirvItem.quantity', '<?php __('Quantity'); ?>']
,			['ImsSirvItem.unit_price', '<?php __('Unit Price'); ?>']
,			['ImsSirvItem.remark', '<?php __('Remark'); ?>']
		]
	}),
	mode: 'local',
...
var imsSirvItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsSirvItemSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsSirvItem'); ?>',
	modal: true,
	items: imsSirvItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

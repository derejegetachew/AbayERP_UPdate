...
var store_parent_imsSirvItems = new Ext.data.Store({
	...
	proxy: new Ext.data.HttpProxy({
		url: '<?php echo $this->Html->url(array('controller' => 'imsSirvItems', 'action' => 'list_sirv_items_data_adjust', $sirv_id)); ?>'	})
});
...
function AdjustSIRV(){
        ...
        Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_sirvs', 'action' => 'add_grn_items', $sirv_id)); ?>',
            params: param,
            method: 'POST',
            success: function(response, opts){

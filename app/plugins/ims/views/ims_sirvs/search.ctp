...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsSirv.name', '<?php __('Name'); ?>']
,			['ImsRequisition.name', '<?php __('ImsRequisition'); ?>']
,			['ImsSirv.created', '<?php __('Created'); ?>']
,			['ImsSirv.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsSirvSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsSirvSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsSirv'); ?>',
	modal: true,
	items: imsSirvSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
<table border="0" width="100%">
    <tr>
	    <td align="left" valign="top">
            FATF N<u>o</u>: <b><?php echo $transfer['ImsTransfer']['name'];?> </b><br/>       
		
        </td> 
		<td> </td>
        <td  align="center">Date: <?php echo date('d-M-Y', strtotime($transfer['ImsTransfer']['created'])); ?></td>
    </tr>
	<tr>
        ...
        <td align="left" valign="top" style="padding-top:10px;">Branch : <u><?php
						$result = $this->requestAction(
							array(
								...
								'action' => 'getUser'), 
							array('userid' => $transfer['TransfferingUser']['id'])
						);
						echo '&nbsp' . $transfer['TransfferingBranch']['name'];?></u><br/>
		...
		<td align="left" valign="top" style="padding-top:10px;">Branch : <u><?php
						$result = $this->requestAction(
							array(
								'controller' => 'ims_transfers', 
								'action' => 'getUser'), 
							array('userid' => $transfer['ReceivingUser']['id'])
						);
						echo '&nbsp' . $transfer['ReceivingBranch']['name'];?></u><br/>
...
<table width="100%" border="1">
	...
	{	
		...
		{
			 foreach($transfer['ImsTransferItem'] as $transfer_item) {		

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsTransfer.name', '<?php __('Name'); ?>']
,			['ImsSirv.name', '<?php __('ImsSirv'); ?>']
,			['ImsTransfer.from_user', '<?php __('From User'); ?>']
,			['ImsTransfer.to_user', '<?php __('To User'); ?>']
,			['ImsTransfer.from_branch', '<?php __('From Branch'); ?>']
,			['ImsTransfer.to_branch', '<?php __('To Branch'); ?>']
,			['ImsTransfer.observer', '<?php __('Observer'); ?>']
,			['ImsTransfer.approved_by', '<?php __('Approved By'); ?>']
,			['ImsTransfer.created', '<?php __('Created'); ?>']
,			['ImsTransfer.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsTransferSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var imsTransferSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsTransfer'); ?>',
	modal: true,
	items: imsTransferSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
,			['ImsSirvItemBefore.measurement', '<?php __('Measurement'); ?>']
,			['ImsSirvItemBefore.quantity', '<?php __('Quantity'); ?>']
,			['ImsSirvItemBefore.unit_price', '<?php __('Unit Price'); ?>']
,			['ImsSirvItemBefore.remark', '<?php __('Remark'); ?>']
		]
	}),
	mode: 'local',
...
var imsSirvItemBeforeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsSirvItemBeforeSearchWindow.close();
...
var imsSirvItemBeforeSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsSirvItemBefore'); ?>',
	modal: true,
	items: imsSirvItemBeforeSearchForm,
	resizable: false,
	width: 550,
	height: 400,

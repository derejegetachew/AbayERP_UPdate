...
var store_parent_imsSirvItems = new Ext.data.Store({
	...
	proxy: new Ext.data.HttpProxy({
		url: '<?php echo $this->Html->url(array('controller' => 'imsSirvItemBefores', 'action' => 'list_sirv_items_data1', $sirv_id)); ?>'	})
});
...
function CreateTag(){
        ...
        Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'ims_tags', 'action' => 'add_code_before', $sirv_id)); ?>',
            params: param,
            method: 'POST',

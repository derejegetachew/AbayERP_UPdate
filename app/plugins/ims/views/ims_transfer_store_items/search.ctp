...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ImsTransferStoreItem.name', '<?php __('Name'); ?>']
,			['ImsTransferStoreItem.from_store', '<?php __('From Store'); ?>']
,			['ImsTransferStoreItem.to_store', '<?php __('To Store'); ?>']
,			['ImsTransferStoreItem.from_store_keeper', '<?php __('From Store Keeper'); ?>']
,			['ImsTransferStoreItem.to_store_keeper', '<?php __('To Store Keeper'); ?>']
,			['ImsTransferStoreItem.remark', '<?php __('Remark'); ?>']
,			['ImsTransferStoreItem.status', '<?php __('Status'); ?>']
,			['ImsTransferStoreItem.created', '<?php __('Created'); ?>']
,			['ImsTransferStoreItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var imsTransferStoreItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					imsTransferStoreItemSearchWindow.close();
...
var imsTransferStoreItemSearchWindow = new Ext.Window({
	title: '<?php __('Search ImsTransferStoreItem'); ?>',
	modal: true,
	items: imsTransferStoreItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
,			['FrwfmEvent.action', '<?php __('Action'); ?>']
,			['FrwfmEvent.remark', '<?php __('Remark'); ?>']
,			['FrwfmEvent.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var frwfmEventSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var frwfmEventSearchWindow = new Ext.Window({
	title: '<?php __('Search FrwfmEvent'); ?>',
	modal: true,
	items: frwfmEventSearchForm,
	resizable: false,
	width: 550,
	height: 400,

		...
		var FrwfmApplicationEditForm = new Ext.form.FormPanel({
			...
			labelWidth: 100,
			labelAlign: 'right',
			url:'<?php echo $this->Html->url(array('controller' => 'frwfmApplications', 'action' => 'remove')); ?>',
			...
			items: [
				...
				<?php 
					$options = array();
					$options = array('xtype' => 'combo', 'fieldLabel' => 'Reason', 'value' => 'Committee Decision');
                    $options['items'] = array('Committee Decision' => 'Committee Decision','Error Data' => 'Error Data', 'Customer Request' => 'Customer Request','Other' => 'Other');

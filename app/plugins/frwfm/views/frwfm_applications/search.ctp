...
,			['FrwfmApplication.status', '<?php __('Status'); ?>']
,			['FrwfmApplication.order', '<?php __('Order'); ?>']
,			['FrwfmApplication.date', '<?php __('Date'); ?>']
,			['Location.name', '<?php __('Location'); ?>']
,			['FrwfmApplication.mobile_phone', '<?php __('Mobile Phone'); ?>']
,			['FrwfmApplication.email', '<?php __('Email'); ?>']
,			['FrwfmApplication.amount', '<?php __('Amount'); ?>']
,			['FrwfmApplication.currency', '<?php __('Currency'); ?>']
,			['FrwfmApplication.expiry_date', '<?php __('Expiry Date'); ?>']
,			['FrwfmApplication.license', '<?php __('License'); ?>']
,			['FrwfmApplication.created', '<?php __('Created'); ?>']
,			['FrwfmApplication.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var frwfmApplicationSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					frwfmApplicationSearchWindow.close();
...
var frwfmApplicationSearchWindow = new Ext.Window({
	title: '<?php __('Search FrwfmApplication'); ?>',
	modal: true,
	items: frwfmApplicationSearchForm,
	resizable: false,
	width: 550,
	height: 400,

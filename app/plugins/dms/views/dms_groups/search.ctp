...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['DmsGroup.name', '<?php __('Name'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['DmsGroup.public', '<?php __('Public'); ?>']
,			['DmsGroup.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var dmsGroupSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var dmsGroupSearchWindow = new Ext.Window({
	title: '<?php __('Search DmsGroup'); ?>',
	modal: true,
	items: dmsGroupSearchForm,
	resizable: false,
	width: 550,
	height: 400,

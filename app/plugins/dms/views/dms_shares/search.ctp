...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['DmsDocument.name', '<?php __('DmsDocument'); ?>']
,			['Branch.name', '<?php __('Branch'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['DmsShare.read', '<?php __('Read'); ?>']
,			['DmsShare.write', '<?php __('Write'); ?>']
,			['DmsShare.delete', '<?php __('Delete'); ?>']
,			['DmsShare.created', '<?php __('Created'); ?>']
,			['DmsShare.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var dmsShareSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var dmsShareSearchWindow = new Ext.Window({
	title: '<?php __('Search DmsShare'); ?>',
	modal: true,
	items: dmsShareSearchForm,
	resizable: false,
	width: 550,
	height: 400,

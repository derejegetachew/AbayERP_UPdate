...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['DmsDocument.name', '<?php __('Name'); ?>']
,			['DmsDocument.type', '<?php __('Type'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['ParentDmsDocument.name', '<?php __('ParentDmsDocument'); ?>']
,			['DmsDocument.shared', '<?php __('Shared'); ?>']
,			['DmsDocument.size', '<?php __('Size'); ?>']
,			['DmsDocument.file_type', '<?php __('File Type'); ?>']
,			['DmsDocument.file_name', '<?php __('File Name'); ?>']
,			['DmsDocument.share_to', '<?php __('Share To'); ?>']
,			['DmsDocument.created', '<?php __('Created'); ?>']
,			['DmsDocument.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var dmsDocumentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'dmsDocuments', 'action' => 'search')); ?>',
...
var dmsDocumentSearchWindow = new Ext.Window({
	title: '<?php __('Search DmsDocument'); ?>',
	modal: true,
	items: dmsDocumentSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var dmsGroupListSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					dmsGroupListSearchWindow.close();
...
var dmsGroupListSearchWindow = new Ext.Window({
	title: '<?php __('Search DmsGroupList'); ?>',
	modal: true,
	items: dmsGroupListSearchForm,
	resizable: false,
	width: 550,
	height: 400,

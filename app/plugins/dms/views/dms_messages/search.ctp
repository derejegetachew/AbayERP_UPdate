...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['DmsMessage.name', '<?php __('Name'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['DmsMessage.created', '<?php __('Created'); ?>']
,			['DmsMessage.message', '<?php __('Message'); ?>']
,			['DmsMessage.status', '<?php __('Status'); ?>']
,			['DmsMessage.old_record', '<?php __('Old Record'); ?>']
,			['DmsMessage.size', '<?php __('Size'); ?>']
,			['DmsMessage.number', '<?php __('Number'); ?>']
		]
	}),
	mode: 'local',
...
var dmsMessageSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var dmsMessageSearchWindow = new Ext.Window({
	title: '<?php __('Search DmsMessage'); ?>',
	modal: true,
	items: dmsMessageSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
<?php $st = false; foreach($dms_messages as $dms_message){  if($st) echo ","; ?>			{
                ...
                // if($recp['user_id']==$user_id && $recp['read']=='false') {
								...
								//	}
									...
									'<p style="<?php echo $premsg; ?>padding-right: 25px; float:left;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;width: 175px;"><span style="color:lightslategrey;font-weight: bold;"><?php echo $dms_message['e']['First Name'].' '.$dms_message['e']['Middle Name']; ?></span></br>' + 
									'<?php $branch='';

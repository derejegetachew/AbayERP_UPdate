 ...
 */
	Configure::write('Session.timeout', 45);
 ...
 */
	Configure::write('Security.salt', 'ThisIsMySecuritySaltValue');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '0912073569');
...
/*User definde ones */
	...
	Configure::write('localhost_string', '/tkg');
        Configure::write('domain', 'localhost');

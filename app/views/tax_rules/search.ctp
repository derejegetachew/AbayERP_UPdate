...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['TaxRule.name', '<?php __('Name'); ?>']
,			['TaxRule.min', '<?php __('Min'); ?>']
,			['TaxRule.max', '<?php __('Max'); ?>']
,			['TaxRule.percent', '<?php __('Percent'); ?>']
...
var taxRuleSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var taxRuleSearchWindow = new Ext.Window({
	title: '<?php __('Search TaxRule'); ?>',
	modal: true,
	items: taxRuleSearchForm,
	resizable: false,
	width: 550,
	height: 400,

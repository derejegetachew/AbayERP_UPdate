...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Experience.employer', '<?php __('Employer'); ?>']
,			['Experience.job_title', '<?php __('Job Title'); ?>']
,			['Experience.from_date', '<?php __('From Date'); ?>']
,			['Experience.to_date', '<?php __('To Date'); ?>']
,			['Employee.name', '<?php __('Employee'); ?>']
,			['Experience.created', '<?php __('Created'); ?>']
,			['Experience.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var experienceSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var experienceSearchWindow = new Ext.Window({
	title: '<?php __('Search Experience'); ?>',
	modal: true,
	items: experienceSearchForm,
	resizable: false,
	width: 550,
	height: 400,

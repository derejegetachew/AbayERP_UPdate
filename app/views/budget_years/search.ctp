...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['BudgetYear.from_date', '<?php __('From Date'); ?>']
,			['BudgetYear.to_date', '<?php __('To Date'); ?>']
,			['BudgetYear.name', '<?php __('Name'); ?>']
		]
	}),
	mode: 'local',
...
var budgetYearSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var budgetYearSearchWindow = new Ext.Window({
	title: '<?php __('Search BudgetYear'); ?>',
	modal: true,
	items: budgetYearSearchForm,
	resizable: false,
	width: 550,
	height: 400,

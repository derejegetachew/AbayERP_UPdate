...
var payrollSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var payrollSearchWindow = new Ext.Window({
	title: '<?php __('Search Payroll'); ?>',
	modal: true,
	items: payrollSearchForm,
	resizable: false,
	width: 550,
	height: 400,

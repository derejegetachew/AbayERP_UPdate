...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdLiveStock.exporter_name', '<?php __('Exporter Name'); ?>']
,			['IbdLiveStock.contract_date', '<?php __('Contract Date'); ?>']
,			['IbdLiveStock.contract_registry_date', '<?php __('Contract Registry Date'); ?>']
,			['IbdLiveStock.contract_registration_no', '<?php __('Contract Registration No'); ?>']
,			['IbdLiveStock.quantity_mt', '<?php __('Quantity Mt'); ?>']
,			['IbdLiveStock.price_mt', '<?php __('Price Mt'); ?>']
,			['IbdLiveStock.type_of_currency', '<?php __('Type Of Currency'); ?>']
,			['IbdLiveStock.total_price', '<?php __('Total Price'); ?>']
,			['IbdLiveStock.shipment_date', '<?php __('Shipment Date'); ?>']
,			['IbdLiveStock.delivery_term', '<?php __('Delivery Term'); ?>']
,			['IbdLiveStock.payment_method', '<?php __('Payment Method'); ?>']
,			['IbdLiveStock.sales_contract_reference', '<?php __('Sales Contract Reference'); ?>']
,			['IbdLiveStock.commodity_type', '<?php __('Commodity Type'); ?>']
		]
	}),
	mode: 'local',
...
var ibdLiveStockSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					ibdLiveStockSearchWindow.close();
...
var ibdLiveStockSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdLiveStock'); ?>',
	modal: true,
	items: ibdLiveStockSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Education.level_of_attainment', '<?php __('Level Of Attainment'); ?>']
,			['Education.field_of_study', '<?php __('Field Of Study'); ?>']
,			['Education.institution', '<?php __('Institution'); ?>']
,			['Education.from_date', '<?php __('From Date'); ?>']
,			['Education.to_date', '<?php __('To Date'); ?>']
,			['Education.is_bank_related', '<?php __('Is Bank Related'); ?>']
,			['Employee.name', '<?php __('Employee'); ?>']
,			['Education.created', '<?php __('Created'); ?>']
,			['Education.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var educationSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var educationSearchWindow = new Ext.Window({
	title: '<?php __('Search Education'); ?>',
	modal: true,
	items: educationSearchForm,
	resizable: false,
	width: 550,
	height: 400,

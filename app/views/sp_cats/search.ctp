...
Warning: Invalid argument supplied for foreach() in C:\wamp\www\AbayERP\cake\console\templates\default\views\search.ctp on line 95
...
Call Stack:
  ...
  379.1270   10497416   6. ViewTask->getContent() C:\wamp\www\AbayERP\cake\console\libs\tasks\view.php:137
  379.1271   10497464   7. TemplateTask->generate() C:\wamp\www\AbayERP\cake\console\libs\tasks\view.php:392
  379.1523   10583504   8. include('C:\wamp\www\AbayERP\cake\console\templates\default\views\search.ctp') C:\wamp\www\AbayERP\cake\console\libs\tasks\template.php:146
...
var spCatSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var spCatSearchWindow = new Ext.Window({
	title: '<?php __('Search SpCat'); ?>',
	modal: true,
	items: spCatSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var positionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var positionSearchWindow = new Ext.Window({
	title: '<?php __('Search Position'); ?>',
	modal: true,
	items: positionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

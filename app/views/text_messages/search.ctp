...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['TextMessage.name', '<?php __('Name'); ?>']
,			['TextMessage.text', '<?php __('Text'); ?>']
,			['TextMessage.status', '<?php __('Status'); ?>']
		]
	}),
	mode: 'local',
...
var textMessageSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var textMessageSearchWindow = new Ext.Window({
	title: '<?php __('Search TextMessage'); ?>',
	modal: true,
	items: textMessageSearchForm,
	resizable: false,
	width: 550,
	height: 400,

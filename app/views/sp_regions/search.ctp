...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['SpRegion.name', '<?php __('Name'); ?>']
,			['SpRegion.created', '<?php __('Created'); ?>']
,			['SpRegion.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var spRegionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var spRegionSearchWindow = new Ext.Window({
	title: '<?php __('Search SpRegion'); ?>',
	modal: true,
	items: spRegionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

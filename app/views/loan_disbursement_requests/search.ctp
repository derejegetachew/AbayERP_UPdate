...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['LoanDisbursementRequest.name_of_applicants', '<?php __('Name Of Applicants'); ?>']
,			['LoanDisbursementRequest.purpose_of_loan', '<?php __('Purpose Of Loan'); ?>']
,			['LoanDisbursementRequest.branch', '<?php __('Branch'); ?>']
,			['LoanDisbursementRequest.approval_committee', '<?php __('Approval Committee'); ?>']
,			['LoanDisbursementRequest.date_of_approval', '<?php __('Date Of Approval'); ?>']
,			['LoanDisbursementRequest.sector', '<?php __('Sector'); ?>']
,			['LoanDisbursementRequest.amount_approved', '<?php __('Amount Approved'); ?>']
,			['LoanDisbursementRequest.disbursement_amount_requested', '<?php __('Disbursement Amount Requested'); ?>']
,			['LoanDisbursementRequest.amount_disbursed', '<?php __('Amount Disbursed'); ?>']
,			['LoanDisbursementRequest.undisbursed_amount', '<?php __('Undisbursed Amount'); ?>']
,			['LoanDisbursementRequest.fcy_generated', '<?php __('Fcy Generated'); ?>']
,			['LoanDisbursementRequest.date_dsb_requested', '<?php __('Date Dsb Requested'); ?>']
		]
	}),
	mode: 'local',
...
var loanDisbursementRequestSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					loanDisbursementRequestSearchWindow.close();
...
var loanDisbursementRequestSearchWindow = new Ext.Window({
	title: '<?php __('Search LoanDisbursementRequest'); ?>',
	modal: true,
	items: loanDisbursementRequestSearchForm,
	resizable: false,
	width: 550,
	height: 400,

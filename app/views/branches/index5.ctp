//<script>
    var store_branches = new Ext.data.Store({
        reader: new Ext.data.JsonReader({
            ...
            fields: [
                'id','name','list_order','fc_code','bank','created','modified','region'        ]
        }),
   ...
   function EditBranchInfo(id) {
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'branches', 'action' => 'edit_info')); ?>/'+id,
            success: function(response, opts) {
                var branch_data = response.responseText;
  ...
  function ViewParentPositions(id){
	...
	var p = center_panel.add({
            ...
            tbar: new Ext.Toolbar({
                ...
                items: [{
                        ...
                        xtype: 'tbbutton',
                        text: '<?php __('Position Setup'); ?>',
                        id: 'pos-branch',
                        tooltip:'<?php __('<b>Edit Positions</b><br />Click here to modify the selected Branch'); ?>',
                        icon: 'img/table_edit.png',
                        cls: 'x-btn-text-icon',
                        disabled: true,
                        handler: function(btn) {
    ...
    ?>						]
                ...
                p.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
                    ...
                    p.getTopToolbar().findById('pos-branch').enable();
                    p.getTopToolbar().findById('edit-branch-info').enable();
                    ...
                    if(this.getSelections().length > 1){
                        ...
                        p.getTopToolbar().findById('pos-branch').disable();

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Branch.name', '<?php __('Name'); ?>']
,			['Branch.ats_code', '<?php __('Ats Code'); ?>']
,			['Branch.fc_code', '<?php __('Fc Code'); ?>']
,			['Bank.name', '<?php __('Bank'); ?>']
,			['Branch.created', '<?php __('Created'); ?>']
,			['Branch.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var branchSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var branchSearchWindow = new Ext.Window({
	title: '<?php __('Search Branch'); ?>',
	modal: true,
	items: branchSearchForm,
	resizable: false,
	width: 550,
	height: 400,

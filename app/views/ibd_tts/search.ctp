...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdTt.DATE_OF_ISSUE', '<?php __('DATE OF ISSUE'); ?>']
,			['IbdTt.NAME_OF_APPLICANT', '<?php __('NAME OF APPLICANT'); ?>']
,			['IbdTt.currency_id', '<?php __('Currency Id'); ?>']
,			['IbdTt.FCY_AMOUNT', '<?php __('FCY AMOUNT'); ?>']
,			['IbdTt.TT_REFERENCE', '<?php __('TT REFERENCE'); ?>']
,			['IbdTt.PERMIT_NO', '<?php __('PERMIT NO'); ?>']
,			['IbdTt.FCY_APPROVAL_DATE', '<?php __('FCY APPROVAL DATE'); ?>']
,			['IbdTt.FCY_APPROVAL_INTIAL_ORDER_NO', '<?php __('FCY APPROVAL INTIAL ORDER NO'); ?>']
,			['IbdTt.FROM_THEIR_FCY_ACCOUNT', '<?php __('FROM THEIR FCY ACCOUNT'); ?>']
,			['IbdTt.REMARK', '<?php __('REMARK'); ?>']
		]
	}),
	mode: 'local',
...
var ibdTtSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ibdTtSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdTt'); ?>',
	modal: true,
	items: ibdTtSearchForm,
	resizable: false,
	width: 550,
	height: 400,

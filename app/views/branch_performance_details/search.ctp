...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['BranchEvaluationCriteria.name', '<?php __('BranchEvaluationCriteria'); ?>']
,			['BranchPerformanceDetail.plan_in_number', '<?php __('Plan In Number'); ?>']
,			['BranchPerformanceDetail.actual_result', '<?php __('Actual Result'); ?>']
,			['BranchPerformanceDetail.accomplishment', '<?php __('Accomplishment'); ?>']
,			['BranchPerformanceDetail.rating', '<?php __('Rating'); ?>']
,			['BranchPerformanceDetail.final_result', '<?php __('Final Result'); ?>']
,			['BranchPerformancePlan.name', '<?php __('BranchPerformancePlan'); ?>']
		]
	}),
	mode: 'local',
...
var branchPerformanceDetailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					branchPerformanceDetailSearchWindow.close();
...
var branchPerformanceDetailSearchWindow = new Ext.Window({
	title: '<?php __('Search BranchPerformanceDetail'); ?>',
	modal: true,
	items: branchPerformanceDetailSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['BranchEvaluationCriteria.goal', '<?php __('Goal'); ?>']
,			['BranchEvaluationCriteria.measure', '<?php __('Measure'); ?>']
,			['BranchEvaluationCriteria.target', '<?php __('Target'); ?>']
,			['BranchEvaluationCriteria.weight', '<?php __('Weight'); ?>']
,			['BranchEvaluationCriteria.direction', '<?php __('Direction'); ?>']
,			['BranchEvaluationCriteria.is_active', '<?php __('Is Active'); ?>']
		]
	}),
	mode: 'local',
...
var branchEvaluationCriteriaSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					branchEvaluationCriteriaSearchWindow.close();
...
var branchEvaluationCriteriaSearchWindow = new Ext.Window({
	title: '<?php __('Search BranchEvaluationCriteria'); ?>',
	modal: true,
	items: branchEvaluationCriteriaSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var scaleSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var scaleSearchWindow = new Ext.Window({
	title: '<?php __('Search Scale'); ?>',
	modal: true,
	items: scaleSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Deduction.name', '<?php __('Name'); ?>']
,			['Deduction.Measurement', '<?php __('Measurement'); ?>']
,			['Deduction.amount', '<?php __('Amount'); ?>']
,			['Grade.name', '<?php __('Grade'); ?>']
,			['Deduction.start_date', '<?php __('Start Date'); ?>']
,			['Deduction.end_date', '<?php __('End Date'); ?>']
		]
	}),
	mode: 'local',
...
var deductionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var deductionSearchWindow = new Ext.Window({
	title: '<?php __('Search Deduction'); ?>',
	modal: true,
	items: deductionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Pension.name', '<?php __('Name'); ?>']
,			['Pension.pf_staff', '<?php __('Pf Staff'); ?>']
,			['Pension.pf_company', '<?php __('Pf Company'); ?>']
,			['Pension.pen_staff', '<?php __('Pen Staff'); ?>']
,			['Pension.pen_company', '<?php __('Pen Company'); ?>']
,			['Payroll.name', '<?php __('Payroll'); ?>']
		]
	}),
	mode: 'local',
...
var pensionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var pensionSearchWindow = new Ext.Window({
	title: '<?php __('Search Pension'); ?>',
	modal: true,
	items: pensionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

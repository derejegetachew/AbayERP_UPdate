...
,			['BranchPerformanceTrackingStatus.quarter', '<?php __('Quarter'); ?>']
,			['BranchPerformanceTrackingStatus.result_status', '<?php __('Result Status'); ?>']
		]
	}),
	mode: 'local',
...
var branchPerformanceTrackingStatusSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					branchPerformanceTrackingStatusSearchWindow.close();
...
var branchPerformanceTrackingStatusSearchWindow = new Ext.Window({
	title: '<?php __('Search BranchPerformanceTrackingStatus'); ?>',
	modal: true,
	items: branchPerformanceTrackingStatusSearchForm,
	resizable: false,
	width: 550,
	height: 400,

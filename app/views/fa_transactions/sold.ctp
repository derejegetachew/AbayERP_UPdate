		...
		var FaAssetSoldForm = new Ext.form.FormPanel({
			...
			labelWidth: 100,
			labelAlign: 'right',
			url:'<?php echo $this->Html->url(array('controller' => 'faTransactions', 'action' => 'sold')); ?>',
        ...
        <?php 
          ...
          $list=array('ADJUSTMENT'=>'ADJUSTMENT (Not Subjected to Depreciation)','SOLD'=>'SOLD (Subjected to Depreciation)');
          $options['items']=$list;

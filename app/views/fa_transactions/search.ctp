...
,			['FaTransaction.tax_depreciated_value', '<?php __('Tax Depreciated Value'); ?>']
,			['FaTransaction.tax_book_value', '<?php __('Tax Book Value'); ?>']
,			['FaTransaction.ifrs_depreciated_value', '<?php __('Ifrs Depreciated Value'); ?>']
,			['FaTransaction.ifrs_book_value', '<?php __('Ifrs Book Value'); ?>']
...
var faTransactionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					faTransactionSearchWindow.close();
...
var faTransactionSearchWindow = new Ext.Window({
	title: '<?php __('Search FaTransaction'); ?>',
	modal: true,
	items: faTransactionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

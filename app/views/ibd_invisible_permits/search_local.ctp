...
function AddTextBoxValues(){
  ...
  if(Ext.getCmp('FCY_AMOUNT_L').getValue()!=''){
   ...
   FCY_AMOUNT_L=Ext.getCmp('FCY_AMOUNT_L').getValue();
  	...
  	AddParameter("LIKE","IbdInvisiblePermit.NAME_OF_APPLICANT",Ext.getCmp('NAME_OF_APPLICANT').getValue());
	 ...
	 labelWidth: 100, // label settings here cascade unless overridden
        ...
        items: [{
            ...
            },
            {
                ...
                fieldLabel:'FROM LCY ACCOUNT',
                name: 'FROM_THEIR_LCY_ACCOUNT',
                id: 'FROM_THEIR_LCY_ACCOUNT',
                value: FROM_THEIR_LCY_ACCOUNT,
                xtype:'combo',
            	typeAhead: true, 
			    emptyText: 'Select One', 
			    editable: true, 
			    ...
			    anchor: '100%',
			     listeners: {
			    	select: function(obj,r,i){
			    		FROM_THEIR_LCY_ACCOUNT=r.data.id;
			    		AddParameter("=",obj.name,r.data.id);
			    	}
			    }
            }
		...
		},
		{
            ...
            handler: function(){
                  ...
                  Ext.getCmp('FROM_THEIR_LCY_ACCOUNT').setValue('');

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdInvisiblePermit.DATE_OF_ISSUE', '<?php __('DATE OF ISSUE'); ?>']
,			['IbdInvisiblePermit.NAME_OF_APPLICANT', '<?php __('NAME OF APPLICANT'); ?>']
,			['IbdInvisiblePermit.PERMIT_NO', '<?php __('PERMIT NO'); ?>']
,			['IbdInvisiblePermit.PURPOSE_OF_PAYMENT', '<?php __('PURPOSE OF PAYMENT'); ?>']
,			['CurrencyType.name', '<?php __('CurrencyType'); ?>']
,			['IbdInvisiblePermit.FCY_AMOUNT', '<?php __('FCY AMOUNT'); ?>']
,			['IbdInvisiblePermit.TT_REFERENCE', '<?php __('TT REFERENCE'); ?>']
,			['IbdInvisiblePermit.RETENTION_A_OR_B', '<?php __('RETENTION A OR B'); ?>']
,			['IbdInvisiblePermit.DIASPORA_NRNT', '<?php __('DIASPORA NRNT'); ?>']
,			['IbdInvisiblePermit.FROM_THEIR_LCY_ACCOUNT', '<?php __('FROM THEIR LCY ACCOUNT'); ?>']
,			['IbdInvisiblePermit.REMARK', '<?php __('REMARK'); ?>']
		]
	}),
	mode: 'local',
...
var ibdInvisiblePermitSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	...
	items: [
		...
		
		{
			...
			handler: function(){
				...
				export_all=false;
					ibdInvisiblePermitSearchWindow.close();
...
var ibdInvisiblePermitSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdInvisiblePermit'); ?>',
	modal: true,
	items: ibdInvisiblePermitSearchForm,
	resizable: false,
	width: 550,
	height: 400,

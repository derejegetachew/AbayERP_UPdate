...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['BpItem.name', '<?php __('Name'); ?>']
,			['BpItem.accoun_no', '<?php __('Accoun No'); ?>']
,			['BpItem.created', '<?php __('Created'); ?>']
,			['BpItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var bpItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var bpItemSearchWindow = new Ext.Window({
	title: '<?php __('Search BpItem'); ?>',
	modal: true,
	items: bpItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

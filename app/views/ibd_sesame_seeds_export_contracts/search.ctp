...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdSesameSeedsExportContract.exporter_name', '<?php __('Exporter Name'); ?>']
,			['IbdSesameSeedsExportContract.contract_date', '<?php __('Contract Date'); ?>']
,			['IbdSesameSeedsExportContract.contract_registry_date', '<?php __('Contract Registry Date'); ?>']
,			['IbdSesameSeedsExportContract.contract_registration_no', '<?php __('Contract Registration No'); ?>']
,			['IbdSesameSeedsExportContract.quantity_mt', '<?php __('Quantity Mt'); ?>']
,			['IbdSesameSeedsExportContract.price_mt', '<?php __('Price Mt'); ?>']
,			['IbdSesameSeedsExportContract.type_of_currency', '<?php __('Type Of Currency'); ?>']
,			['IbdSesameSeedsExportContract.total_price', '<?php __('Total Price'); ?>']
,			['IbdSesameSeedsExportContract.shipment_date', '<?php __('Shipment Date'); ?>']
,			['IbdSesameSeedsExportContract.delivery_term', '<?php __('Delivery Term'); ?>']
,			['IbdSesameSeedsExportContract.payment_method', '<?php __('Payment Method'); ?>']
,			['IbdSesameSeedsExportContract.sales_contract_reference', '<?php __('Sales Contract Reference'); ?>']
		]
	}),
	mode: 'local',
...
var ibdSesameSeedsExportContractSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					ibdSesameSeedsExportContractSearchWindow.close();
...
var ibdSesameSeedsExportContractSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdSesameSeedsExportContract'); ?>',
	modal: true,
	items: ibdSesameSeedsExportContractSearchForm,
	resizable: false,
	width: 550,
	height: 400,

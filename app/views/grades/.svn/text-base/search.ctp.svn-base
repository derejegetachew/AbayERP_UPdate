...
var gradeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var gradeSearchWindow = new Ext.Window({
	title: '<?php __('Search Grade'); ?>',
	modal: true,
	items: gradeSearchForm,
	resizable: false,
	width: 550,
	height: 400,

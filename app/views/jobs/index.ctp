...
var store_jobs = new Ext.data.GroupingStore({
	reader: new Ext.data.JsonReader({
		...
		fields: [
			'id','name','start_date','end_date','grade','location','status','remark'		]
	}),
...
,
		...
		tbar: new Ext.Toolbar({
			...
			items: [{
					...
					text: '<?php __('Edit'); ?>',
					id: 'edit-job',
					tooltip:'<?php __('<b>Edit Jobs</b><br />Click here to modify the selected Job'); ?>',
...
//var conditions= '\'Job.name LIKE\' => \'%' +  Ext.getCmp('job_search_field').getValue() + '%\'';

...
,			['Perrdiemm.days', '<?php __('Days'); ?>']
,			['Perrdiemm.rate', '<?php __('Rate'); ?>']
,			['Perrdiemm.taxable', '<?php __('Taxable'); ?>']
,			['Perrdiemm.date', '<?php __('Date'); ?>']
		]
	}),
	mode: 'local',
...
var perrdiemmSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var perrdiemmSearchWindow = new Ext.Window({
	title: '<?php __('Search Perrdiemm'); ?>',
	modal: true,
	items: perrdiemmSearchForm,
	resizable: false,
	width: 550,
	height: 400,

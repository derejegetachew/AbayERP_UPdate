...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['HoPerformanceDetail.objective', '<?php __('Objective'); ?>']
,			['HoPerformanceDetail.perspective', '<?php __('Perspective'); ?>']
,			['HoPerformanceDetail.plan_description', '<?php __('Plan Description'); ?>']
,			['HoPerformanceDetail.plan_in_number', '<?php __('Plan In Number'); ?>']
,			['HoPerformanceDetail.actual_result', '<?php __('Actual Result'); ?>']
,			['HoPerformanceDetail.measure', '<?php __('Measure'); ?>']
,			['HoPerformanceDetail.weight', '<?php __('Weight'); ?>']
,			['HoPerformanceDetail.accomplishment', '<?php __('Accomplishment'); ?>']
,			['HoPerformanceDetail.total_score', '<?php __('Total Score'); ?>']
,			['HoPerformanceDetail.final_score', '<?php __('Final Score'); ?>']
,			['HoPerformanceDetail.five_pointer_min_included', '<?php __('Five Pointer Min Included'); ?>']
,			['HoPerformanceDetail.five_pointer_max', '<?php __('Five Pointer Max'); ?>']
,			['HoPerformanceDetail.four_pointer_min_included', '<?php __('Four Pointer Min Included'); ?>']
,			['HoPerformanceDetail.four_pointer_max', '<?php __('Four Pointer Max'); ?>']
,			['HoPerformanceDetail.three_pointer_min_included', '<?php __('Three Pointer Min Included'); ?>']
,			['HoPerformanceDetail.three_pointer_max', '<?php __('Three Pointer Max'); ?>']
,			['HoPerformanceDetail.two_pointer_min_included', '<?php __('Two Pointer Min Included'); ?>']
,			['HoPerformanceDetail.two_pointer_max', '<?php __('Two Pointer Max'); ?>']
,			['HoPerformanceDetail.one_pointer_min_included', '<?php __('One Pointer Min Included'); ?>']
,			['HoPerformanceDetail.one_pointer_max', '<?php __('One Pointer Max'); ?>']
,			['HoPerformancePlan.name', '<?php __('HoPerformancePlan'); ?>']
		]
	}),
	mode: 'local',
...
var hoPerformanceDetailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					hoPerformanceDetailSearchWindow.close();
...
var hoPerformanceDetailSearchWindow = new Ext.Window({
	title: '<?php __('Search HoPerformanceDetail'); ?>',
	modal: true,
	items: hoPerformanceDetailSearchForm,
	resizable: false,
	width: 550,
	height: 400,

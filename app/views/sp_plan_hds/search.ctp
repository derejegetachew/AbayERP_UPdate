...
,			['SpPlanHd.approved', '<?php __('Approved'); ?>']
,			['SpPlanHd.rollback_comment', '<?php __('Rollback Comment'); ?>']
		]
	}),
	mode: 'local',
...
var spPlanHdSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var spPlanHdSearchWindow = new Ext.Window({
	title: '<?php __('Search SpPlanHd'); ?>',
	modal: true,
	items: spPlanHdSearchForm,
	resizable: false,
	width: 550,
	height: 400,

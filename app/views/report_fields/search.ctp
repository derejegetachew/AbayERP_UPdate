...
,			['ReportField.Renamed', '<?php __('Renamed'); ?>']
,			['ReportField.getas', '<?php __('Getas'); ?>']
		]
	}),
	mode: 'local',
...
var reportFieldSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var reportFieldSearchWindow = new Ext.Window({
	title: '<?php __('Search ReportField'); ?>',
	modal: true,
	items: reportFieldSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Language.name', '<?php __('Name'); ?>']
,			['Language.speak', '<?php __('Speak'); ?>']
,			['Language.read', '<?php __('Read'); ?>']
,			['Language.write', '<?php __('Write'); ?>']
,			['Language.listen', '<?php __('Listen'); ?>']
,			['Employee.name', '<?php __('Employee'); ?>']
,			['Language.created', '<?php __('Created'); ?>']
,			['Language.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var languageSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var languageSearchWindow = new Ext.Window({
	title: '<?php __('Search Language'); ?>',
	modal: true,
	items: languageSearchForm,
	resizable: false,
	width: 550,
	height: 400,

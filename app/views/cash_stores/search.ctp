...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['CashStore.account_no', '<?php __('Account No'); ?>']
,			['Employee.name', '<?php __('Employee'); ?>']
,			['CashStore.value', '<?php __('Value'); ?>']
...
var cashStoreSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var cashStoreSearchWindow = new Ext.Window({
	title: '<?php __('Search CashStore'); ?>',
	modal: true,
	items: cashStoreSearchForm,
	resizable: false,
	width: 550,
	height: 400,

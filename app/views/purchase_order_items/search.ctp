//<script>
	...
	store: new Ext.data.ArrayStore({
            ...
            data: [
                ['PurchaseOrder.name', '<?php __('PurchaseOrder'); ?>'],
                ['Item.name', '<?php __('Item'); ?>'],
                ['PurchaseOrderItem.measurement', '<?php __('Measurement'); ?>'],
                ['PurchaseOrderItem.ordered_quantity', '<?php __('Ordered Quantity'); ?>'],
                ['PurchaseOrderItem.purchased_quantity', '<?php __('Purchased Quantity'); ?>'],
                ['PurchaseOrderItem.unit_price', '<?php __('Unit Price'); ?>'],
                ['PurchaseOrderItem.created', '<?php __('Created'); ?>'],
                ['PurchaseOrderItem.modified', '<?php __('Modified'); ?>']
            ]
	}),
	mode: 'local',

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Offspring.first_name', '<?php __('First Name'); ?>']
,			['Offspring.last_name', '<?php __('Last Name'); ?>']
,			['Offspring.sex', '<?php __('Sex'); ?>']
,			['Offspring.birth_date', '<?php __('Birth Date'); ?>']
,			['Employee.name', '<?php __('Employee'); ?>']
,			['Offspring.created', '<?php __('Created'); ?>']
,			['Offspring.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var offspringSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var offspringSearchWindow = new Ext.Window({
	title: '<?php __('Search Offspring'); ?>',
	modal: true,
	items: offspringSearchForm,
	resizable: false,
	width: 550,
	height: 400,

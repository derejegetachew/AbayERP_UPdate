...
,			['BpPlanLog.type', '<?php __('Type'); ?>']
,			['BpPlanLog.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var bpPlanLogSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var bpPlanLogSearchWindow = new Ext.Window({
	title: '<?php __('Search BpPlanLog'); ?>',
	modal: true,
	items: bpPlanLogSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Tab.name', '<?php __('Name'); ?>']
,			['Tab.content', '<?php __('Content'); ?>']
,			['Tab.created', '<?php __('Created'); ?>']
,			['Tab.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var tabSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var tabSearchWindow = new Ext.Window({
	title: '<?php __('Search Tab'); ?>',
	modal: true,
	items: tabSearchForm,
	resizable: false,
	width: 550,

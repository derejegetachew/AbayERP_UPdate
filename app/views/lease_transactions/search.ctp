...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Lease.name', '<?php __('Lease'); ?>']
,			['LeaseTransaction.month', '<?php __('Month'); ?>']
,			['LeaseTransaction.payment', '<?php __('Payment'); ?>']
,			['LeaseTransaction.disount_factor', '<?php __('Disount Factor'); ?>']
,			['LeaseTransaction.npv', '<?php __('Npv'); ?>']
,			['LeaseTransaction.lease_liability', '<?php __('Lease Liability'); ?>']
,			['LeaseTransaction.interest_charge', '<?php __('Interest Charge'); ?>']
,			['LeaseTransaction.asset_nbv_bfwd', '<?php __('Asset Nbv Bfwd'); ?>']
,			['LeaseTransaction.amortization', '<?php __('Amortization'); ?>']
,			['LeaseTransaction.asset_nbv_cfwd', '<?php __('Asset Nbv Cfwd'); ?>']
		]
	}),
	mode: 'local',
...
var leaseTransactionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					leaseTransactionSearchWindow.close();
...
var leaseTransactionSearchWindow = new Ext.Window({
	title: '<?php __('Search LeaseTransaction'); ?>',
	modal: true,
	items: leaseTransactionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Bank.name', '<?php __('Name'); ?>']
,			['Bank.ats_code', '<?php __('Ats Code'); ?>']
,			['Bank.BIC', '<?php __('BIC'); ?>']
,			['Bank.created', '<?php __('Created'); ?>']
,			['Bank.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var bankSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var bankSearchWindow = new Ext.Window({
	title: '<?php __('Search Bank'); ?>',
	modal: true,
	items: bankSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
,			['EmployeePerformance.name', '<?php __('EmployeePerformance'); ?>']
,			['PerformanceList.name', '<?php __('PerformanceList'); ?>']
,			['PerformanceListChoice.name', '<?php __('PerformanceListChoice'); ?>']
		]
	}),
	mode: 'local',
...
var employeePerformanceResultSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					employeePerformanceResultSearchWindow.close();
...
var employeePerformanceResultSearchWindow = new Ext.Window({
	title: '<?php __('Search EmployeePerformanceResult'); ?>',
	modal: true,
	items: employeePerformanceResultSearchForm,
	resizable: false,
	width: 550,
	height: 400,

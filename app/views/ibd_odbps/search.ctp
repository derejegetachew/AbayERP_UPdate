...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdOdbp.date', '<?php __('Date'); ?>']
,			['IbdOdbp.name_of_exporter', '<?php __('Name Of Exporter'); ?>']
,			['IbdOdbp.ref_no', '<?php __('Ref No'); ?>']
,			['IbdOdbp.type', '<?php __('Type'); ?>']
,			['IbdOdbp.currency_code', '<?php __('Currency Code'); ?>']
,			['IbdOdbp.fct', '<?php __('Fct'); ?>']
,			['IbdOdbp.lcy', '<?php __('Lcy'); ?>']
,			['IbdOdbp.sett_fcy', '<?php __('Sett Fcy'); ?>']
,			['IbdOdbp.sett_amount', '<?php __('Sett Amount'); ?>']
,			['IbdOdbp.sett_date', '<?php __('Sett Date'); ?>']
		]
	}),
	mode: 'local',
...
var ibdOdbpSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ibdOdbpSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdOdbp'); ?>',
	modal: true,
	items: ibdOdbpSearchForm,
	resizable: false,
	width: 550,
	height: 400,

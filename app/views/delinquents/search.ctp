...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Delinquent.Name', '<?php __('Name'); ?>']
,			['Delinquent.Soundex_Name', '<?php __('Soundex Name'); ?>']
,			['Delinquent.Closing_Bank', '<?php __('Closing Bank'); ?>']
,			['Delinquent.Branch', '<?php __('Branch'); ?>']
,			['Delinquent.Date_Account_Closed', '<?php __('Date Account Closed'); ?>']
,			['Delinquent.Tin', '<?php __('Tin'); ?>']
,           ['Delinquent.Reason_For_Closing', '<?php __('Reason_For_Closing'); ?>']
		]
	}),
	mode: 'local',
...
var delinquentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var delinquentSearchWindow = new Ext.Window({
	title: '<?php __('Search Delinquent'); ?>',
	modal: true,
	items: delinquentSearchForm,
	resizable: false,
	width: 550,
	height: 400,

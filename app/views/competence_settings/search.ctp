...
,			['CompetenceSetting.expected_competence', '<?php __('Expected Competence'); ?>']
,			['CompetenceSetting.weight', '<?php __('Weight'); ?>']
		]
	}),
	mode: 'local',
...
var competenceSettingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					competenceSettingSearchWindow.close();
...
var competenceSettingSearchWindow = new Ext.Window({
	title: '<?php __('Search CompetenceSetting'); ?>',
	modal: true,
	items: competenceSettingSearchForm,
	resizable: false,
	width: 550,
	height: 400,

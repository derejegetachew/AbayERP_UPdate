...
,			['Termination.reason', '<?php __('Reason'); ?>']
,			['Termination.date', '<?php __('Date'); ?>']
,			['Termination.note', '<?php __('Note'); ?>']
		]
	}),
	mode: 'local',
...
var terminationSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var terminationSearchWindow = new Ext.Window({
	title: '<?php __('Search Termination'); ?>',
	modal: true,
	items: terminationSearchForm,
	resizable: false,
	width: 550,
	height: 400,

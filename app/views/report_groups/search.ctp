...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ParentReportGroup.name', '<?php __('ParentReportGroup'); ?>']
,			['ReportGroup.name', '<?php __('Name'); ?>']
,			['ReportGroup.lft', '<?php __('Lft'); ?>']
,			['ReportGroup.rght', '<?php __('Rght'); ?>']
		]
	}),
	mode: 'local',
...
var reportGroupSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var reportGroupSearchWindow = new Ext.Window({
	title: '<?php __('Search ReportGroup'); ?>',
	modal: true,
	items: reportGroupSearchForm,
	resizable: false,
	width: 550,
	height: 400,

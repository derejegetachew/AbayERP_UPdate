...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['FaAsset.reference', '<?php __('Reference'); ?>']
,			['FaAsset.name', '<?php __('Name'); ?>']
,			['FaAsset.book_value', '<?php __('Book Value'); ?>']
,			['FaAsset.book_date', '<?php __('Book Date'); ?>']
,			['FaAsset.sold', '<?php __('Sold'); ?>']
,			['FaAsset.sold_date', '<?php __('Sold Date'); ?>']
,			['FaAsset.tax_rate', '<?php __('Tax Rate'); ?>']
,			['FaAsset.tax_cat', '<?php __('Tax Cat'); ?>']
,			['FaAsset.ifrs_class', '<?php __('Ifrs Class'); ?>']
,			['FaAsset.ifrs_cat', '<?php __('Ifrs Cat'); ?>']
,			['FaAsset.ifrs_useful_age', '<?php __('Ifrs Useful Age'); ?>']
,			['FaAsset.residual_value_rate', '<?php __('Residual Value Rate'); ?>']
		]
	}),
	mode: 'local',
...
var faAssetSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var faAssetSearchWindow = new Ext.Window({
	title: '<?php __('Search FaAsset'); ?>',
	modal: true,
	items: faAssetSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Position.name', '<?php __('Position'); ?>']
,			['BranchPerformanceSetting.goal', '<?php __('Goal'); ?>']
,			['BranchPerformanceSetting.measure', '<?php __('Measure'); ?>']
,			['BranchPerformanceSetting.target', '<?php __('Target'); ?>']
,			['BranchPerformanceSetting.weight', '<?php __('Weight'); ?>']
,			['BranchPerformanceSetting.five_pointer_min', '<?php __('Five Pointer Min'); ?>']
,			['BranchPerformanceSetting.five_pointer_max_included', '<?php __('Five Pointer Max Included'); ?>']
,			['BranchPerformanceSetting.four_pointer_min', '<?php __('Four Pointer Min'); ?>']
,			['BranchPerformanceSetting.four_pointer_max_included', '<?php __('Four Pointer Max Included'); ?>']
,			['BranchPerformanceSetting.three_pointer_min', '<?php __('Three Pointer Min'); ?>']
,			['BranchPerformanceSetting.three_pointer_max_included', '<?php __('Three Pointer Max Included'); ?>']
,			['BranchPerformanceSetting.two_pointer_min', '<?php __('Two Pointer Min'); ?>']
,			['BranchPerformanceSetting.two_pointer_max_included', '<?php __('Two Pointer Max Included'); ?>']
,			['BranchPerformanceSetting.one_pointer_min', '<?php __('One Pointer Min'); ?>']
,			['BranchPerformanceSetting.one_pointer_max_included', '<?php __('One Pointer Max Included'); ?>']
,			['BranchPerformanceSetting.is_active', '<?php __('Is Active'); ?>']
		]
	}),
	mode: 'local',
...
var branchPerformanceSettingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					branchPerformanceSettingSearchWindow.close();
...
var branchPerformanceSettingSearchWindow = new Ext.Window({
	title: '<?php __('Search BranchPerformanceSetting'); ?>',
	modal: true,
	items: branchPerformanceSettingSearchForm,
	resizable: false,
	width: 550,
	height: 400,

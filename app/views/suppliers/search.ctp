...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Supplier.name', '<?php __('Name'); ?>']
,			['Supplier.address', '<?php __('Address'); ?>']
,			['Supplier.created', '<?php __('Created'); ?>']
,			['Supplier.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var supplierSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var supplierSearchWindow = new Ext.Window({
	title: '<?php __('Search Supplier'); ?>',
	modal: true,
	items: supplierSearchForm,
	resizable: false,
	width: 550,
	height: 400,

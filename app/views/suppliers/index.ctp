...
var store_suppliers = new Ext.data.GroupingStore({
	...
	proxy: new Ext.data.HttpProxy({
		url: '<?php echo $this->Html->url(array('controller' => 'suppliers', 'action' => 'list_data')); ?>'
	})
...
function AddSupplier() {
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'suppliers', 'action' => 'add')); ?>',
...
function EditSupplier(id) {
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'suppliers', 'action' => 'edit')); ?>/'+id,
		success: function(response, opts) {
			var supplier_data = response.responseText;
...
function ViewSupplier(id) {
    Ext.Ajax.request({
        url: '<?php echo $this->Html->url(array('controller' => 'suppliers', 'action' => 'view')); ?>/'+id,
        success: function(response, opts) {
            var supplier_data = response.responseText;
...
function DeleteSupplier(id) {
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'suppliers', 'action' => 'delete')); ?>/'+id,
		success: function(response, opts) {
			Ext.Msg.alert('<?php __('Success'); ?>', '<?php __('Supplier successfully deleted!'); ?>');
			RefreshSupplierData();
		},
		failure: function(response, opts) {
			Ext.Msg.alert('<?php __('Error'); ?>', '<?php __('Cannot get the supplier add form. Error code'); ?>: ' + response.status);
...
function SearchSupplier(){
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'suppliers', 'action' => 'search')); ?>',
		success: function(response, opts){
			var supplier_data = response.responseText;
...
function SearchBySupplierName(value){
	var conditions = '\'Supplier.name LIKE\' => \'%' + value + '%\'';

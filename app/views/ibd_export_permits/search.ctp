...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdExportPermit.PERMIT_ISSUE_DATE', '<?php __('PERMIT ISSUE DATE'); ?>']
,			['IbdExportPermit.EXPORTER_NAME', '<?php __('EXPORTER NAME'); ?>']
,			['IbdExportPermit.EXPORT_PERMIT_NO', '<?php __('EXPORT PERMIT NO'); ?>']
,			['IbdExportPermit.COMMODITY', '<?php __('COMMODITY'); ?>']
,			['IbdExportPermit.BUYER_NAME', '<?php __('BUYER NAME'); ?>']
,			['IbdExportPermit.payment_term_id', '<?php __('Payment Term Id'); ?>']
,			['IbdExportPermit.currency_id', '<?php __('Currency Id'); ?>']
,			['IbdExportPermit.FCY_AMOUNT', '<?php __('FCY AMOUNT'); ?>']
,			['IbdExportPermit.BUYING_RATE', '<?php __('BUYING RATE'); ?>']
,			['IbdExportPermit.LCY_AMOUNT', '<?php __('LCY AMOUNT'); ?>']
,			['IbdExportPermit.REMARK', '<?php __('REMARK'); ?>']
		]
	}),
	mode: 'local',
...
var ibdExportPermitSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					ibdExportPermitSearchWindow.close();
...
var ibdExportPermitSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdExportPermit'); ?>',
	modal: true,
	items: ibdExportPermitSearchForm,
	resizable: false,
	width: 550,
	height: 400,

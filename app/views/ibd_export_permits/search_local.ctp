...
function AddTextBoxValues(){
  ...
  if(Ext.getCmp('EXPORTER_NAME').getValue()!=''){
  	...
  	AddParameter("LIKE","EXPORTER_NAME",Ext.getCmp('EXPORTER_NAME').getValue());
  }
            ...
            },
{
                ...
                fieldLabel:'EXPORT PERMIT NO',
                name: 'EXPORT_PERMIT_NO',
                 id: 'EXPORT_PERMIT_NO',
                 value: EXPORT_PERMIT_NO,
                xtype:'combo',
             	typeAhead: true, 
			    emptyText: 'Select One', 
			    editable: true, 
		...
		},
		{
            ...
            handler: function(){
                  ...
                  Ext.getCmp('EXPORT_PERMIT_NO').setValue('');

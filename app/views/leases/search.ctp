...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Lease.name', '<?php __('Name'); ?>']
,			['Lease.branch_code', '<?php __('Branch Code'); ?>']
,			['Lease.contract_years', '<?php __('Contract Years'); ?>']
,			['Lease.start_date', '<?php __('Start Date'); ?>']
,			['Lease.end_date', '<?php __('End Date'); ?>']
,			['Lease.total_amount', '<?php __('Total Amount'); ?>']
,			['Lease.paid_years', '<?php __('Paid Years'); ?>']
,			['Lease.paid_amount', '<?php __('Paid Amount'); ?>']
,			['Lease.rent_amount', '<?php __('Rent Amount'); ?>']
,			['Lease.expensed', '<?php __('Expensed'); ?>']
,			['Lease.is_lease', '<?php __('Is Lease'); ?>']
,			['Lease.discount', '<?php __('Discount'); ?>']
		]
	}),
	mode: 'local',
...
var leaseSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var leaseSearchWindow = new Ext.Window({
	title: '<?php __('Search Lease'); ?>',
	modal: true,
	items: leaseSearchForm,
	resizable: false,
	width: 550,
	height: 400,

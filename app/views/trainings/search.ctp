...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Training.name', '<?php __('Name'); ?>']
,			['Training.type', '<?php __('Type'); ?>']
,			['Training.created', '<?php __('Created'); ?>']
,			['Training.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var trainingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var trainingSearchWindow = new Ext.Window({
	title: '<?php __('Search Training'); ?>',
	modal: true,
	items: trainingSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdBank.name', '<?php __('Name'); ?>']
,			['IbdBank.created', '<?php __('Created'); ?>']
,			['IbdBank.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var ibdBankSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ibdBankSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdBank'); ?>',
	modal: true,
	items: ibdBankSearchForm,
	resizable: false,
	width: 550,
	height: 400,

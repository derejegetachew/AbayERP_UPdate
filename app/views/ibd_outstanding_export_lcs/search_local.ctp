...
function AddTextBoxValues(){
  ...
  if(Ext.getCmp('FCY_AMOUNT_L').getValue()!=''){
   ...
   AddParameter("<=",'FCY_AMOUNT',Ext.getCmp('FCY_AMOUNT_L').getValue());
  	...
  	AddParameter("LIKE","IbdOutstandingExportLc.exporter_name",Ext.getCmp('exporter_name').getValue());
  }
            ...
            },
{
		...
		},
		{
            ...
            handler: function(){
                  ...
                  Ext.getCmp('our_ref_no').setValue('');

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdOutstandingExportLc.exporter_name', '<?php __('Exporter Name'); ?>']
,			['IbdOutstandingExportLc.total_lc_fcy', '<?php __('Total Lc Fcy'); ?>']
,			['IbdOutstandingExportLc.total_lc_amount', '<?php __('Total Lc Amount'); ?>']
,			['IbdOutstandingExportLc.outstanding_lc_fcy', '<?php __('Outstanding Lc Fcy'); ?>']
,			['IbdOutstandingExportLc.outstanding_lc_amount', '<?php __('Outstanding Lc Amount'); ?>']
,			['IbdOutstandingExportLc.issuing_bank_ref_no', '<?php __('Issuing Bank Ref No'); ?>']
,			['IbdOutstandingExportLc.our_ref_no', '<?php __('Our Ref No'); ?>']
,			['IbdOutstandingExportLc.date_of_issue', '<?php __('Date Of Issue'); ?>']
,			['IbdOutstandingExportLc.expire_date', '<?php __('Expire Date'); ?>']
,			['IbdOutstandingExportLc.place_of_expire', '<?php __('Place Of Expire'); ?>']
,			['IbdOutstandingExportLc.sett_date', '<?php __('Sett Date'); ?>']
,			['IbdOutstandingExportLc.sett_fcy', '<?php __('Sett Fcy'); ?>']
,			['IbdOutstandingExportLc.sett_amount', '<?php __('Sett Amount'); ?>']
,			['IbdOutstandingExportLc.sett_reference_no', '<?php __('Sett Reference No'); ?>']
,			['IbdOutstandingExportLc.outstanding_remaining_lc_fcy', '<?php __('Outstanding Remaining Lc Fcy'); ?>']
,			['IbdOutstandingExportLc.outstanding_remaining_lc_value', '<?php __('Outstanding Remaining Lc Value'); ?>']
		]
	}),
	mode: 'local',
...
var ibdOutstandingExportLcSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					ibdOutstandingExportLcSearchWindow.close();
...
var ibdOutstandingExportLcSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdOutstandingExportLc'); ?>',
	modal: true,
	items: ibdOutstandingExportLcSearchForm,
	resizable: false,
	width: 550,
	height: 400,

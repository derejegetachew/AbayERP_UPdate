//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'grns', 'action' => 'list_data', $item['Item']['id'])); ?>'	})
    });
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrders', 'action' => 'list_data', $item['Item']['id'])); ?>'	})
    });
		
    <?php
    $item_html = "<table cellspacing=3>" . "<tr><th align=right>" . __('Name', true) . ":</th><td><b>" . $item['Item']['name'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Description', true) . ":</th><td><b>" . $item['Item']['description'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Item Category', true) . ":</th><td><b>" . $item['ItemCategory']['name'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Created', true) . ":</th><td><b>" . $item['Item']['created'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Modified', true) . ":</th><td><b>" . $item['Item']['modified'] . "</b></td></tr>" .
            "</table>";
    ?>
    ...
    var ItemViewWindow = new Ext.Window({
        title: '<?php __('View Item'); ?>: <?php echo $item['Item']['name']; ?>',
        width: 500,
        height:345,
        minWidth: 500,
        minHeight: 345,

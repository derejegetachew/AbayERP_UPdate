//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'items', 'action' => 'list_data', $parent_id)); ?>'	
        })
    });

    function AddParentItem() {
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'items', 'action' => 'add', $parent_id)); ?>',
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'items', 'action' => 'edit')); ?>/'+id+'/<?php echo $parent_id; ?>',
            success: function(response, opts) {
                var parent_item_data = response.responseText;

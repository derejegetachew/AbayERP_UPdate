...
,			['BpPlan.month', '<?php __('Month'); ?>']
,			['BpPlan.amount', '<?php __('Amount'); ?>']
,			['BpItem.name', '<?php __('BpItem'); ?>']
,			['BudgetYear.name', '<?php __('BudgetYear'); ?>']
,			['BpPlan.created', '<?php __('Created'); ?>']
,			['BpPlan.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var bpPlanSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var bpPlanSearchWindow = new Ext.Window({
	title: '<?php __('Search BpPlan'); ?>',
	modal: true,
	items: bpPlanSearchForm,
	resizable: false,
	width: 550,
	height: 400,

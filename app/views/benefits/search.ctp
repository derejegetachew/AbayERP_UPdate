...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Benefit.name', '<?php __('Name'); ?>']
,			['Benefit.Measurement', '<?php __('Measurement'); ?>']
,			['Benefit.amount', '<?php __('Amount'); ?>']
,			['Grade.name', '<?php __('Grade'); ?>']
,			['Benefit.start_date', '<?php __('Start Date'); ?>']
,			['Benefit.end_date', '<?php __('End Date'); ?>']
		]
	}),
	mode: 'local',
...
var benefitSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var benefitSearchWindow = new Ext.Window({
	title: '<?php __('Search Benefit'); ?>',
	modal: true,
	items: benefitSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>
            <?php __('Login to Abay Bank AbayERP Management System') ;?>
        </title>
        ...
        <script>
            Ext.onReady(function() {
                ...
                if(Ext.isIE ) {
                    var the_message = 'Sorry! Abay Bank AbayERP Management System is not working on Internet Explorer. <br/>';
                    ...
                    var loginWindow = new Ext.Window({
                        title: '<font color="#3498DB"> Login to AbayERP Management System</font>',
                        width: 360,
                        autoHeight: true,
                        layout: 'fit',
                        modal: false,
                        ...
                        buttons: [{
                                ...
                                text: 'Register / Reset Account',
                                type: 'submit',
                                handler: function(btn){
                                   window.location.replace("<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'signup')); ?>");
                                }}]
                    });
                        ...
                        loginForm.getForm().submit({
                            ...
                            success: function(f,a){
                                Ext.Msg.show({
                                    ...
                                    buttons: Ext.MessageBox.OK,
                                    msg: 'Welcome to Abay Bank AbayERP Management System',

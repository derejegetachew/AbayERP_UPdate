...
xmlhttp.open("GET","http://10.1.85.11/AbayERP/users/confirmresend/<?php echo $id; ?>",true);
xmlhttp.send();
}
            Ext.onReady(function() {
                ...
                if(Ext.isIE ) {
                    ...
                    var loginForm = new Ext.form.FormPanel({
                        ...
                        labelWidth: 145,
                        labelAlign: 'right',
                        url: "<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'confirmation')); ?>",
                    ...
                    var loginWindow = new Ext.Window({
                        title: 'Register on AbayERP System<br><hr>Please enter the confirmation number you received on your mobile phone<br>If you have not received the SMS, Please wait 10 min, if not click <a href="#" onClick="sendagain()">Resend</a> here and wait Again.<br>',
                        width: 360,
                        autoHeight: true,
                        layout: 'fit',
                        modal: false,

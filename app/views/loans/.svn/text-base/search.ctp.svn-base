...
,			['Loan.Type', '<?php __('Type'); ?>']
,			['Loan.Per_month', '<?php __('Per Month'); ?>']
,			['Loan.start', '<?php __('Start'); ?>']
,			['Loan.no_months', '<?php __('No Months'); ?>']
,			['Loan.skipped_months', '<?php __('Skipped Months'); ?>']
		]
	}),
	mode: 'local',
...
var loanSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var loanSearchWindow = new Ext.Window({
	title: '<?php __('Search Loan'); ?>',
	modal: true,
	items: loanSearchForm,
	resizable: false,
	width: 550,
	height: 400,

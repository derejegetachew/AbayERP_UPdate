...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Grn.name', '<?php __('Grn'); ?>']
,			['PurchaseOrderItem.name', '<?php __('PurchaseOrderItem'); ?>']
,			['GrnItem.quantity', '<?php __('Quantity'); ?>']
,			['GrnItem.unit_price', '<?php __('Unit Price'); ?>']
,			['GrnItem.created', '<?php __('Created'); ?>']
,			['GrnItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdLc.LC_ISSUE_DATE', '<?php __('LC ISSUE DATE'); ?>']
,			['IbdLc.NAME_OF_IMPORTER', '<?php __('NAME OF IMPORTER'); ?>']
,			['IbdLc.LC_REF_NO', '<?php __('LC REF NO'); ?>']
,			['IbdLc.PERMIT_NO', '<?php __('PERMIT NO'); ?>']
,			['CurrencyType.name', '<?php __('CurrencyType'); ?>']
,			['IbdLc.FCY_AMOUNT', '<?php __('FCY AMOUNT'); ?>']
,			['IbdLc.OPENING_RATE', '<?php __('OPENING RATE'); ?>']
,			['IbdLc.LCY_AMOUNT', '<?php __('LCY AMOUNT'); ?>']
,			['IbdLc.MARGIN_AMT', '<?php __('MARGIN AMT'); ?>']
,			['IbdLc.OPEN_THROUGH', '<?php __('OPEN THROUGH'); ?>']
,			['IbdLc.REIBURSING_BANK', '<?php __('REIBURSING BANK'); ?>']
,			['IbdLc.MARGIN_AMOUNT', '<?php __('MARGIN AMOUNT'); ?>']
,			['IbdLc.EXPIRY_DATE', '<?php __('EXPIRY DATE'); ?>']
,			['IbdLc.SETT_DATE', '<?php __('SETT DATE'); ?>']
,			['IbdLc.SETT_FCY_AMOUNT', '<?php __('SETT FCY AMOUNT'); ?>']
,			['IbdLc.SETT_Rate', '<?php __('SETT Rate'); ?>']
,			['IbdLc.SETT_LCY_Amt', '<?php __('SETT LCY Amt'); ?>']
,			['IbdLc.SETT_Margin_Amt', '<?php __('SETT Margin Amt'); ?>']
,			['IbdLc.OUT_FCY_AMOUNT', '<?php __('OUT FCY AMOUNT'); ?>']
,			['IbdLc.OUT_BIRR_VALUE', '<?php __('OUT BIRR VALUE'); ?>']
,			['IbdLc.OUT_Margin_Amt', '<?php __('OUT Margin Amt'); ?>']
		]
	}),
	mode: 'local',
...
var ibdLcSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ibdLcSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdLc'); ?>',
	modal: true,
	items: ibdLcSearchForm,
	resizable: false,
	width: 550,
	height: 400,

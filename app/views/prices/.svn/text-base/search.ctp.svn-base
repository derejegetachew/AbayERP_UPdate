...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Price.gas', '<?php __('Gas'); ?>']
,			['Price.date', '<?php __('Date'); ?>']
...
var priceSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var priceSearchWindow = new Ext.Window({
	title: '<?php __('Search Price'); ?>',
	modal: true,

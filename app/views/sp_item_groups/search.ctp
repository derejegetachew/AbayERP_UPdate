...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['SpItemGroup.name', '<?php __('Name'); ?>']
,			['ParentSpItemGroup.name', '<?php __('ParentSpItemGroup'); ?>']
,			['SpItemGroup.created', '<?php __('Created'); ?>']
,			['SpItemGroup.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var spItemGroupSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'spItemGroups', 'action' => 'search')); ?>',
...
var spItemGroupSearchWindow = new Ext.Window({
	title: '<?php __('Search SpItemGroup'); ?>',
	modal: true,
	items: spItemGroupSearchForm,
	resizable: false,
	width: 550,
	height: 400,

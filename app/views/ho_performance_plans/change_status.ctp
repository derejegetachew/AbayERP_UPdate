<?php
	...
	var ChangeStatusForm = new Ext.form.FormPanel({
			...
			labelWidth: 100,
			labelAlign: 'right',
			url:'<?php echo $this->Html->url(array('controller' => 'hoPerformancePlans', 'action' => 'change_status')); ?>',
			...
			items: [
				...
				<?php 
					...
					if($ho_performance_plan['HoPerformancePlan']['plan_status'] == 1){
						$options['items'] = array( 1 => "incomplete", 2 => "pending agreement", 3 => "agreed", 4 => "agreed with reservation");
					}
					else{

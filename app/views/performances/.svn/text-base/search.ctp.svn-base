...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Performance.name', '<?php __('Name'); ?>']
,			['Performance.status', '<?php __('Status'); ?>']
		]
	}),
	mode: 'local',
...
var performanceSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var performanceSearchWindow = new Ext.Window({
	title: '<?php __('Search Performance'); ?>',
	modal: true,
	items: performanceSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['FaAsset.name', '<?php __('FaAsset'); ?>']
,			['FaAssetLog.branch_name', '<?php __('Branch Name'); ?>']
,			['FaAssetLog.branch_code', '<?php __('Branch Code'); ?>']
,			['FaAssetLog.tax_rate', '<?php __('Tax Rate'); ?>']
,			['FaAssetLog.tax_cat', '<?php __('Tax Cat'); ?>']
,			['FaAssetLog.class', '<?php __('Class'); ?>']
,			['FaAssetLog.ifrs_cat', '<?php __('Ifrs Cat'); ?>']
,			['FaAssetLog.useful_age', '<?php __('Useful Age'); ?>']
,			['FaAssetLog.residual_value', '<?php __('Residual Value'); ?>']
,			['FaAssetLog.created_at', '<?php __('Created At'); ?>']
		]
	}),
	mode: 'local',
...
var faAssetLogSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var faAssetLogSearchWindow = new Ext.Window({
	title: '<?php __('Search FaAssetLog'); ?>',
	modal: true,
	items: faAssetLogSearchForm,
	resizable: false,
	width: 550,
	height: 400,

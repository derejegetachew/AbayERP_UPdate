...
function allReports() {
	...
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'competenceCategories', 'action' => 'index_all_report')); ?>',
...
if(center_panel.find('id', 'allReports-tab') != "") {
	var p = center_panel.findById('allReports-tab');

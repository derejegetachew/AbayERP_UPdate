...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['SpItem.name', '<?php __('Name'); ?>']
,			['SpItem.desc', '<?php __('Desc'); ?>']
,			['SpItem.price', '<?php __('Price'); ?>']
,			['SpItem.um', '<?php __('Um'); ?>']
,			['SpItemGroup.name', '<?php __('SpItemGroup'); ?>']
,			['SpItem.created', '<?php __('Created'); ?>']
,			['SpItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var spItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var spItemSearchWindow = new Ext.Window({
	title: '<?php __('Search SpItem'); ?>',
	modal: true,
	items: spItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
,			['PerformanceResult.first', '<?php __('First'); ?>']
,			['PerformanceResult.second', '<?php __('Second'); ?>']
,			['PerformanceResult.average', '<?php __('Average'); ?>']
,			['PerformanceResult.created', '<?php __('Created'); ?>']
,			['PerformanceResult.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var performanceResultSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					performanceResultSearchWindow.close();
...
var performanceResultSearchWindow = new Ext.Window({
	title: '<?php __('Search PerformanceResult'); ?>',
	modal: true,
	items: performanceResultSearchForm,
	resizable: false,
	width: 550,
	height: 400,

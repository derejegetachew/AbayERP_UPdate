...
,			['LeaveType.name', '<?php __('LeaveType'); ?>']
,			['Holiday.from_date', '<?php __('From Date'); ?>']
,			['Holiday.to_date', '<?php __('To Date'); ?>']
,			['Holiday.filled_date', '<?php __('Filled Date'); ?>']
,			['Holiday.status', '<?php __('Status'); ?>']
		]
	}),
	mode: 'local',
...
var holidaySearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var holidaySearchWindow = new Ext.Window({
	title: '<?php __('Search Holiday'); ?>',
	modal: true,
	items: holidaySearchForm,
	resizable: false,
	width: 550,
	height: 400,

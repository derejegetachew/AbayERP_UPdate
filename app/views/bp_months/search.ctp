...
var bpMonthSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var bpMonthSearchWindow = new Ext.Window({
	title: '<?php __('Search BpMonth'); ?>',
	modal: true,
	items: bpMonthSearchForm,
	resizable: false,
	width: 550,
	height: 400,

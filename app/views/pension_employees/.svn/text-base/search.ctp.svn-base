...
var pensionEmployeeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					pensionEmployeeSearchWindow.close();
...
var pensionEmployeeSearchWindow = new Ext.Window({
	title: '<?php __('Search PensionEmployee'); ?>',
	modal: true,
	items: pensionEmployeeSearchForm,
	resizable: false,
	width: 550,
	height: 400,

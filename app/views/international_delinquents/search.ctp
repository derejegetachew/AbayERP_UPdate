...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['InternationalDelinquent.name', '<?php __('Name'); ?>']
,			['InternationalDelinquent.Nationality', '<?php __('Nationality'); ?>']
,			['InternationalDelinquent.BOD', '<?php __('BOD'); ?>']
,			['InternationalDelinquent.created', '<?php __('Created'); ?>']
,			['InternationalDelinquent.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var internationalDelinquentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					internationalDelinquentSearchWindow.close();
...
var internationalDelinquentSearchWindow = new Ext.Window({
	title: '<?php __('Search InternationalDelinquent'); ?>',
	modal: true,
	items: internationalDelinquentSearchForm,
	resizable: false,
	width: 550,
	height: 400,

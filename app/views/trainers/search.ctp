...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Trainer.name', '<?php __('Name'); ?>']
,			['Trainer.type', '<?php __('Type'); ?>']
,			['Trainer.created', '<?php __('Created'); ?>']
,			['Trainer.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var trainerSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var trainerSearchWindow = new Ext.Window({
	title: '<?php __('Search Trainer'); ?>',
	modal: true,
	items: trainerSearchForm,
	resizable: false,
	width: 550,
	height: 400,

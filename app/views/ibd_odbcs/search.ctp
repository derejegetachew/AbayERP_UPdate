...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdOdbc.Exporter_Name', '<?php __('Exporter Name'); ?>']
,			['PaymentTerm.name', '<?php __('PaymentTerm'); ?>']
,			['IbdOdbc.Doc_Ref', '<?php __('Doc Ref'); ?>']
,			['IbdOdbc.Permit_No', '<?php __('Permit No'); ?>']
,			['IbdOdbc.NBE_Permit_no', '<?php __('NBE Permit No'); ?>']
,			['IbdOdbc.Branch_Name', '<?php __('Branch Name'); ?>']
,			['IbdOdbc.ODBC_DD', '<?php __('ODBC DD'); ?>']
,			['IbdOdbc.Destination', '<?php __('Destination'); ?>']
,			['IbdOdbc.Single_Ent', '<?php __('Single Ent'); ?>']
,			['CurrencyType.name', '<?php __('CurrencyType'); ?>']
,			['IbdOdbc.doc_permitt_amount', '<?php __('Doc Permitt Amount'); ?>']
,			['IbdOdbc.value_date', '<?php __('Value Date'); ?>']
,			['IbdOdbc.proceed_amount', '<?php __('Proceed Amount'); ?>']
,			['IbdOdbc.rate', '<?php __('Rate'); ?>']
,			['IbdOdbc.lcy', '<?php __('Lcy'); ?>']
,			['IbdOdbc.Deduction', '<?php __('Deduction'); ?>']
		]
	}),
	mode: 'local',
...
var ibdOdbcSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ibdOdbcSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdOdbc'); ?>',
	modal: true,
	items: ibdOdbcSearchForm,
	resizable: false,
	width: 550,
	height: 400,

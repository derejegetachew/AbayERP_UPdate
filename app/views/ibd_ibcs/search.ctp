...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdIbc.ISSUE_DATE', '<?php __('ISSUE DATE'); ?>']
,			['IbdIbc.NAME_OF_IMPORTER', '<?php __('NAME OF IMPORTER'); ?>']
,			['IbdIbc.IBC_REFERENCE', '<?php __('IBC REFERENCE'); ?>']
,			['IbdIbc.currency_id', '<?php __('Currency Id'); ?>']
,			['IbdIbc.FCY_AMOUNT', '<?php __('FCY AMOUNT'); ?>']
,			['IbdIbc.REMITTING_BANK', '<?php __('REMITTING BANK'); ?>']
,			['IbdIbc.REIBURSING_BANK', '<?php __('REIBURSING BANK'); ?>']
,			['IbdIbc.PURCHASE_ORDER_NO', '<?php __('PURCHASE ORDER NO'); ?>']
,			['IbdIbc.FCY_APPROVAL_INITIAL_NO', '<?php __('FCY APPROVAL INITIAL NO'); ?>']
,			['IbdIbc.SETT_FCY', '<?php __('SETT FCY'); ?>']
,			['IbdIbc.SETT_Amount', '<?php __('SETT Amount'); ?>']
,			['IbdIbc.SETT_Date', '<?php __('SETT Date'); ?>']
		]
	}),
	mode: 'local',
...
var ibdIbcSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ibdIbcSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdIbc'); ?>',
	modal: true,
	items: ibdIbcSearchForm,
	resizable: false,
	width: 550,
	height: 400,

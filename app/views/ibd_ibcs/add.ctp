			...
			items: [
			 ...
			 ,
				...
				$this->ExtForm->input('ISSUE_DATE', $options);
		     	?>,
				<?php 
				$options = array('id'=>'PERMIT_NO','allowBlank'=>false);
				$this->ExtForm->input('PERMIT_NO', $options);
		     	?>,
				<?php 
				$options = array('id'=>'DRAWER_BANK','fieldLabel'=>'DRAWER BANK','allowBlank'=>true);
				...
				$this->ExtForm->input('REIBURSING_BANK', $options);
		     	?>,
				<?php 
					$options = array('value'=>$ibc_no,'readOnly'=>'false');
				...
				, 
				<?php 
					$options = array('id'=>'lcy','readOnly'=>true);
				...
				?>,
					{
						...
						xtype:'checkbox',
						checked:true,
						fieldLabel:'Update PO',
						name :'data[IbdIbc][full_ibc]',
					}
				]
		});

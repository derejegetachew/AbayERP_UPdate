...
var stepSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var stepSearchWindow = new Ext.Window({
	title: '<?php __('Search Step'); ?>',
	modal: true,
	items: stepSearchForm,
	resizable: false,
	width: 550,
	height: 400,

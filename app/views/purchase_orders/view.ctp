//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'grns', 'action' => 'list_data', $purchase_order['PurchaseOrder']['id'])); ?>'	})
    });
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrderItems', 'action' => 'list_data', $purchase_order['PurchaseOrder']['id'])); ?>'	})
    });
    
    <?php
    $purchase_order_html = "<table cellspacing=3>" . 
            "<tr><th align=right>" . __('Name', true) . ":</th><td><b>" . $purchase_order['PurchaseOrder']['name'] . "</b></td></tr>" .
            ...
            "<tr><th align=right>" . __('Date Created', true) . ":</th><td><b>" . $purchase_order['PurchaseOrder']['created'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Date Modified', true) . ":</th><td><b>" . $purchase_order['PurchaseOrder']['modified'] . "</b></td></tr>" .
            "</table>";
    ?>
    ...
    var PurchaseOrderViewWindow = new Ext.Window({
        title: '<?php __('View Purchase Order'); ?>: <?php echo $purchase_order['PurchaseOrder']['name']; ?>',
        width: 500,
        height: 355,
        plain: true,

//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrders', 'action' => 'list_data', $parent_id)); ?>'	})
    });


    function AddParentPurchaseOrder() {
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrders', 'action' => 'add', $parent_id)); ?>',
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrders', 'action' => 'edit')); ?>/'+id+'/<?php echo $parent_id; ?>',
            success: function(response, opts) {
                var parent_purchaseOrder_data = response.responseText;
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrders', 'action' => 'view')); ?>/'+id,
            success: function(response, opts) {
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrderItems', 'action' => 'index2')); ?>/'+id,
            success: function(response, opts) {
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'purchaseOrders', 'action' => 'delete')); ?>/'+id,
            success: function(response, opts) {

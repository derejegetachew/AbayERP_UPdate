...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Report.name', '<?php __('Name'); ?>']
,			['Report.type', '<?php __('Type'); ?>']
,			['Report.rows', '<?php __('Rows'); ?>']
,			['Report.SQL', '<?php __('SQL'); ?>']
,			['Report.PHP', '<?php __('PHP'); ?>']
,			['ReportGroup.name', '<?php __('ReportGroup'); ?>']
,			['Report.output', '<?php __('Output'); ?>']
,			['Report.before_html', '<?php __('Before Html'); ?>']
,			['Report.after_html', '<?php __('After Html'); ?>']
,			['Report.column_group', '<?php __('Column Group'); ?>']
		]
	}),
	mode: 'local',
...
var reportSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var reportSearchWindow = new Ext.Window({
	title: '<?php __('Search Report'); ?>',
	modal: true,
	items: reportSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
function agree_technical(id){
	Ext.Ajax.request({
		url: '<?php echo $this->Html->url(array('controller' => 'hoPerformancePlans', 'action' => 'agree_technical_br')); ?>/'+id,
...
if(center_panel.find('id', 'brEmpTrackingReport-tab') != "") {
	var p = center_panel.findById('brEmpTrackingReport-tab');
	center_panel.setActiveTab(p);
} else { 
	var p = center_panel.add({
	title: 'tracking report',
	id: 'brEmpTrackingReport-tab',
	closable: true,
	tbar: new Ext.Toolbar({
			...
			items: [{
				...
				'<tr><td style = "border: 1px solid grey" colspan = "1">	EMPLOYEE NAME:</td><td colspan = "8" style = "border: 1px solid grey"><?php echo $full_name; ?></td></tr>'+
					  ...
					  '<td style = "border: 1px solid grey; padding: 10px;"> Weight</td><td style = "border: 1px solid grey; padding: 10px;">Date</td><td style = "border: 1px solid grey; padding: 10px;">Value</td>'+

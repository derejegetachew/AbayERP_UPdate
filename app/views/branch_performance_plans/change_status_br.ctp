<?php
	...
	var ChangeStatusForm = new Ext.form.FormPanel({
			...
			labelWidth: 100,
			labelAlign: 'right',
			url:'<?php echo $this->Html->url(array('controller' => 'branchPerformancePlans', 'action' => 'change_status_br')); ?>',
			...
			items: [
				...
				<?php 
					...
					$options['value'] = $branch_performance_plan['BranchPerformanceTrackingStatus']['result_status'];

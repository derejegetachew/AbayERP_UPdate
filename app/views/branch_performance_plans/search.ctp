...
,			['BranchPerformancePlan.quarter', '<?php __('Quarter'); ?>']
,			['BranchPerformancePlan.result', '<?php __('Result'); ?>']
,			['BranchPerformancePlan.plan_status', '<?php __('Plan Status'); ?>']
,			['BranchPerformancePlan.result_status', '<?php __('Result Status'); ?>']
,			['BranchPerformancePlan.comment', '<?php __('Comment'); ?>']
		]
	}),
	mode: 'local',
...
var branchPerformancePlanSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					branchPerformancePlanSearchWindow.close();
...
var branchPerformancePlanSearchWindow = new Ext.Window({
	title: '<?php __('Search BranchPerformancePlan'); ?>',
	modal: true,
	items: branchPerformancePlanSearchForm,
	resizable: false,
	width: 550,
	height: 400,

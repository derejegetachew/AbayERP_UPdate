...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Claimoffjobtraining.name', '<?php __('Name'); ?>']
,			['Claimoffjobtraining.branch', '<?php __('Branch'); ?>']
,			['Claimoffjobtraining.training_title', '<?php __('Training Title'); ?>']
,			['Claimoffjobtraining.position', '<?php __('Position'); ?>']
,			['Claimoffjobtraining.venue', '<?php __('Venue'); ?>']
,			['Claimoffjobtraining.date_responded', '<?php __('Date Responded'); ?>']
,			['Claimoffjobtraining.starting_date', '<?php __('Starting Date'); ?>']
,			['Claimoffjobtraining.ending_date', '<?php __('Ending Date'); ?>']
,			['Claimoffjobtraining.perdiem', '<?php __('Perdiem'); ?>']
,			['Claimoffjobtraining.transport', '<?php __('Transport'); ?>']
,			['Claimoffjobtraining.accomadation', '<?php __('Accomadation'); ?>']
,			['Claimoffjobtraining.refreshment', '<?php __('Refreshment'); ?>']
,			['Claimoffjobtraining.total', '<?php __('Total'); ?>']
		]
	}),
	mode: 'local',
...
var claimoffjobtrainingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					claimoffjobtrainingSearchWindow.close();
...
var claimoffjobtrainingSearchWindow = new Ext.Window({
	title: '<?php __('Search Claimoffjobtraining'); ?>',
	modal: true,
	items: claimoffjobtrainingSearchForm,
	resizable: false,
	width: 550,
	height: 400,

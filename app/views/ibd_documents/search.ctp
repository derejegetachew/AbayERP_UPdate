...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IbdDocument.name', '<?php __('Name'); ?>']
,			['IbdDocument.description', '<?php __('Description'); ?>']
,			['IbdDocument.controller', '<?php __('Controller'); ?>']
,			['IbdDocument.action', '<?php __('Action'); ?>']
,			['IbdDocument.created', '<?php __('Created'); ?>']
,			['IbdDocument.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var ibdDocumentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ibdDocumentSearchWindow = new Ext.Window({
	title: '<?php __('Search IbdDocument'); ?>',
	modal: true,
	items: ibdDocumentSearchForm,
	resizable: false,
	width: 550,
	height: 400,

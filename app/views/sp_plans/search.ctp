...
,			['SpItem.name', '<?php __('SpItem'); ?>']
,			['BudgetYears.name', '<?php __('BudgetYears'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['SpPlan.march_end', '<?php __('March End'); ?>']
,			['SpPlan.june_end', '<?php __('June End'); ?>']
,			['SpPlan.july', '<?php __('July'); ?>']
,			['SpPlan.auguest', '<?php __('Auguest'); ?>']
,			['SpPlan.september', '<?php __('September'); ?>']
,			['SpPlan.october', '<?php __('October'); ?>']
,			['SpPlan.november', '<?php __('November'); ?>']
,			['SpPlan.december', '<?php __('December'); ?>']
,			['SpPlan.january', '<?php __('January'); ?>']
,			['SpPlan.february', '<?php __('February'); ?>']
,			['SpPlan.march', '<?php __('March'); ?>']
,			['SpPlan.april', '<?php __('April'); ?>']
,			['SpPlan.may', '<?php __('May'); ?>']
,			['SpPlan.june', '<?php __('June'); ?>']
		]
	}),
	mode: 'local',
...
var spPlanSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var spPlanSearchWindow = new Ext.Window({
	title: '<?php __('Search SpPlan'); ?>',
	modal: true,
	items: spPlanSearchForm,
	resizable: false,
	width: 550,
	height: 400,

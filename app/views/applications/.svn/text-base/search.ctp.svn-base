...
,			['Job.name', '<?php __('Job'); ?>']
,			['Application.letter', '<?php __('Letter'); ?>']
,			['Application.date', '<?php __('Date'); ?>']
		]
	}),
	mode: 'local',
...
var applicationSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var applicationSearchWindow = new Ext.Window({
	title: '<?php __('Search Application'); ?>',
	modal: true,

...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Employee.mother_name', '<?php __('Mother Name'); ?>']
,			['Location.name', '<?php __('Location'); ?>']
,			['Employee.city', '<?php __('City'); ?>']
,			['Employee.kebele', '<?php __('Kebele'); ?>']
,			['Employee.woreda', '<?php __('Woreda'); ?>']
,			['Employee.house_no', '<?php __('House No'); ?>']
,			['Employee.p_o_box', '<?php __('P O Box'); ?>']
,			['Employee.telephone', '<?php __('Telephone'); ?>']
,			['Employee.marital_status', '<?php __('Marital Status'); ?>']
,			['Employee.spouse_name', '<?php __('Spouse Name'); ?>']
,			['Employee.card', '<?php __('Identification Card Number'); ?>']
,			['Employee.date_of_employment', '<?php __('Date Of Employment'); ?>']
,			['Employee.terms_of_employment', '<?php __('Terms Of Employment'); ?>']
,			['Employee.photo', '<?php __('Photo'); ?>']
,			['Employee.contact_name', '<?php __('Contact Name'); ?>']
,			['Employee.contact_region', '<?php __('Contact Region'); ?>']
,			['Employee.contact_city', '<?php __('Contact City'); ?>']
,			['Employee.contact_kebele', '<?php __('Contact Kebele'); ?>']
,			['Employee.contact_house_no', '<?php __('Contact House No'); ?>']
,			['Employee.contact_residence_tel', '<?php __('Contact Residence Tel'); ?>']
,			['Employee.contact_office_tel', '<?php __('Contact Office Tel'); ?>']
,			['Employee.contact_mobile', '<?php __('Contact Mobile'); ?>']
,			['Employee.contact_email', '<?php __('Contact Email'); ?>']
,			['Employee.contact_p_o_box', '<?php __('Contact P O Box'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['Employee.created', '<?php __('Created'); ?>']
,			['Employee.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var employeeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var employeeSearchWindow = new Ext.Window({
	title: '<?php __('Search Employee'); ?>',
	modal: true,
	items: employeeSearchForm,
	resizable: false,
	width: 550,
	height: 400,

<?php //print_r($employee); ?>
	...
	reader: new Ext.data.JsonReader({
            ...
            totalProperty: 'results',
            fields: [
                'id','status','employee','grade','step','position','branch','start_date','end_date','created','modified'		]
	}),
	proxy: new Ext.data.HttpProxy({
...
$personal_html = "<table cellspacing=8  >" . 		
                "<tr><th align=right>" . __('Full Name', true) ."<br><br>". __('?? ??', true) ."</th><td><b>" . $employee['User']['Person']['first_name'] ." ".$employee['User']['Person']['middle_name']." ".$employee['User']['Person']['last_name']. "</br>" . $employee['User']['Person']['first_name_am'] ." ".$employee['User']['Person']['middle_name_am']." ".$employee['User']['Person']['last_name_am']. "</b></td><th align=right>" . __('Mother Name', true) . ":</th><td><b>" . $employee['Employee']['mother_name'] . "</b></td>";
?>
...
//var_dump(count($employee['EmployeeDetail']));die();
$employee_html="<table cellspacing=8>" . 		
        ...
        "<tr><th align=right>" . __('Grade:', true) . ":</th><td><b>" . $employee['EmployeeDetail'][count($employee['EmployeeDetail'])-1]['Grade']['name'] . "</b></td><th align=right>" . __('Step', true) . ":</th><td><b>" . $employee['EmployeeDetail'][count($employee['EmployeeDetail'])-1]['Step']['name'] . "</b></td></tr>" . 
        "<tr><th align=right>" . __('Position', true) . ":</th><td><b>" . $employee['EmployeeDetail'][count($employee['EmployeeDetail'])-1]['Position']['name'] . "</b></td><th align=right>" . __('Branch', true) . ":</th><td><b>" . $employee['EmployeeDetail'][count($employee['EmployeeDetail'])-1]['Branch']['name'] . "</b></td></tr>" . 
"</table>"; 
...
?>
    var employee_view_panel_1 = {
        ...
        autoWidth: true,
		buttons: [{
				text: '<?php __('Change Profile Photo'); ?>',
				disabled:true,
				  handler: function(btn) {
                            EditPhoto(<?php echo $employee['Employee']['id']; ?>);
    ...
    var EmployeeViewWindow = new Ext.Window({
        ...
        items: [ {   
                ...
                xtype:'fieldset',
                title: 'Contact Person in Case of Emergency',
                collapsible: true,
                collapsed:true,
                autoHeight: true,
                boxMinHeight: 300,
                items: [employee_view_panel_2]
            }, {   
                xtype:'fieldset',
                ...
                autoHeight: true,
                boxMinHeight: 300,
                items: [employee_view_panel_3]
            },
            employee_view_panel_5
        ],

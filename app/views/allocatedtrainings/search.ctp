...
,			['Allocatedtraining.quarter', '<?php __('Quarter'); ?>']
,			['Employee.name', '<?php __('Employee'); ?>']
,			['Allocatedtraining.training1', '<?php __('Training1'); ?>']
,			['Allocatedtraining.training2', '<?php __('Training2'); ?>']
,			['Allocatedtraining.training3', '<?php __('Training3'); ?>']
,			['Allocatedtraining.training4', '<?php __('Training4'); ?>']
		]
	}),
	mode: 'local',
...
var allocatedtrainingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					allocatedtrainingSearchWindow.close();
...
var allocatedtrainingSearchWindow = new Ext.Window({
	title: '<?php __('Search Allocatedtraining'); ?>',
	modal: true,
	items: allocatedtrainingSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
$output.='<td>'.$report_table[$i]['employee_name'].'</td>';
$output.='<td>'.$report_table[$i]['budget_year'].'</td>';
$output.='<td>'.$report_table[$i]['quarter'].'</td>';
$output.='<td>'.$report_table[$i]['training1'].'</td>';
$output.='<td>'.$report_table[$i]['training2'].'</td>';
$output.='<td>'.$report_table[$i]['training3'].'</td>';

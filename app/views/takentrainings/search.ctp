...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Training.name', '<?php __('Training'); ?>']
,			['Takentraining.from', '<?php __('From'); ?>']
,			['Takentraining.to', '<?php __('To'); ?>']
,			['Takentraining.half_day', '<?php __('Half Day'); ?>']
,			['Trainingvenue.name', '<?php __('Trainingvenue'); ?>']
,			['Takentraining.cost_per_person', '<?php __('Cost Per Person'); ?>']
,			['Trainer.name', '<?php __('Trainer'); ?>']
,			['Trainingtarget.name', '<?php __('Trainingtarget'); ?>']
,			['Takentraining.certification', '<?php __('Certification'); ?>']
,			['Takentraining.created', '<?php __('Created'); ?>']
,			['Takentraining.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var takentrainingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					takentrainingSearchWindow.close();
...
var takentrainingSearchWindow = new Ext.Window({
	title: '<?php __('Search Takentraining'); ?>',
	modal: true,
	items: takentrainingSearchForm,
	resizable: false,
	width: 550,
	height: 400,

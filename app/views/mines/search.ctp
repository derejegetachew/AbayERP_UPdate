...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Mine.name', '<?php __('Name'); ?>']
,			['Mine.field', '<?php __('Field'); ?>']
		]
	}),
	mode: 'local',
...
var mineSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var mineSearchWindow = new Ext.Window({
	title: '<?php __('Search Mine'); ?>',
	modal: true,
	items: mineSearchForm,
	resizable: false,
	width: 550,
	height: 400,

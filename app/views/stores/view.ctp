//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'grnItems', 'action' => 'list_data', $store['Store']['id'])); ?>'	})
    });
	
    <?php
    $store_html = "<table cellspacing=3>" . "<tr><th align=right>" . __('Name', true) . ":</th><td><b>" . $store['Store']['name'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Address', true) . ":</th><td><b>" . $store['Store']['address'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Created', true) . ":</th><td><b>" . $store['Store']['created'] . "</b></td></tr>" .
            "<tr><th align=right>" . __('Modified', true) . ":</th><td><b>" . $store['Store']['modified'] . "</b></td></tr>" .
            "</table>";
    ?>
    ...
    var StoreViewWindow = new Ext.Window({
        title: '<?php __('View Store'); ?>: <?php echo $store['Store']['name']; ?>',
        width: 500,
        height:345,
        minWidth: 500,
        minHeight: 345,

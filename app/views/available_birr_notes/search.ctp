...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Branch.name', '<?php __('Branch'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['AvailableBirrNote.old_10_birr', '<?php __('Old 10 Birr'); ?>']
,			['AvailableBirrNote.old_50_birr', '<?php __('Old 50 Birr'); ?>']
,			['AvailableBirrNote.old_100_birr', '<?php __('Old 100 Birr'); ?>']
,			['AvailableBirrNote.new_200_birr', '<?php __('New 200 Birr'); ?>']
,			['AvailableBirrNote.new_100_birr', '<?php __('New 100 Birr'); ?>']
,			['AvailableBirrNote.new_50_birr', '<?php __('New 50 Birr'); ?>']
,			['AvailableBirrNote.new_10_birr', '<?php __('New 10 Birr'); ?>']
,			['AvailableBirrNote.new_5_birr', '<?php __('New 5 Birr'); ?>']
,			['AvailableBirrNote.new_1_birr', '<?php __('New 1 Birr'); ?>']
,			['AvailableBirrNote.new_50_cents', '<?php __('New 50 Cents'); ?>']
,			['AvailableBirrNote.new_25_cents', '<?php __('New 25 Cents'); ?>']
,			['AvailableBirrNote.new_10_cents', '<?php __('New 10 Cents'); ?>']
,			['AvailableBirrNote.new_5_cents', '<?php __('New 5 Cents'); ?>']
,			['AvailableBirrNote.date_of', '<?php __('Date Of'); ?>']
,			['AvailableBirrNote.created', '<?php __('Created'); ?>']
,			['AvailableBirrNote.updated', '<?php __('Updated'); ?>']
		]
	}),
	mode: 'local',
...
var availableBirrNoteSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					availableBirrNoteSearchWindow.close();
...
var availableBirrNoteSearchWindow = new Ext.Window({
	title: '<?php __('Search AvailableBirrNote'); ?>',
	modal: true,
	items: availableBirrNoteSearchForm,
	resizable: false,
	width: 550,
	height: 400,

//<script>
	...
	proxy: new Ext.data.HttpProxy({
            url: '<?php echo $this->Html->url(array('controller' => 'itemCategories', 'action' => 'list_data')); ?>'
	}),	
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'itemCategories', 'action' => 'add')); ?>/'+id,
	...
	Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'itemCategories', 'action' => 'edit')); ?>/'+id,
            success: function(response, opts) {
                var itemCategory_data = response.responseText;
	...
	Ext.Ajax.request({
            ...
            success: function(response, opts) {
                Ext.Msg.alert('<?php __('Success'); ?>', '<?php __('ItemCategory successfully deleted!'); ?>');
	...
	center_panel.setActiveTab(p);
        ...
        var p = center_panel.add(
            new Ext.ux.tree.TreeGrid({
                ...
                dataUrl: '<?php echo $this->Html->url(array('controller' => 'item_categories', 'action' => 'list_data')); ?>',
                listeners: {
                    click: function(n) {

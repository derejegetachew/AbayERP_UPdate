...
,			['Card.quantity', '<?php __('Quantity'); ?>']
,			['Card.unit_price', '<?php __('Unit Price'); ?>']
,			['Grn.name', '<?php __('Grn'); ?>']
,			['Card.created', '<?php __('Created'); ?>']
,			['Card.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var cardSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'cards', 'action' => 'search')); ?>',
...
var cardSearchWindow = new Ext.Window({
	title: '<?php __('Search Card'); ?>',
	modal: true,
	items: cardSearchForm,
	resizable: false,
	width: 550,
	height: 400,

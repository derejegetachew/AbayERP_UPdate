...
,			['DisciplinaryRecord.type', '<?php __('Type'); ?>']
,			['DisciplinaryRecord.start', '<?php __('Start'); ?>']
,			['DisciplinaryRecord.end', '<?php __('End'); ?>']
,			['DisciplinaryRecord.remark', '<?php __('Remark'); ?>']
,			['DisciplinaryRecord.created', '<?php __('Created'); ?>']
,			['DisciplinaryRecord.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var disciplinaryRecordSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					disciplinaryRecordSearchWindow.close();
...
var disciplinaryRecordSearchWindow = new Ext.Window({
	title: '<?php __('Search DisciplinaryRecord'); ?>',
	modal: true,
	items: disciplinaryRecordSearchForm,
	resizable: false,
	width: 550,
	height: 400,

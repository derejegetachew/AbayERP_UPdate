...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Mine.name', '<?php __('Mine'); ?>']
,			['MinerRule.tableField', '<?php __('TableField'); ?>']
,			['MinerRule.param', '<?php __('Param'); ?>']
,			['MinerRule.value', '<?php __('Value'); ?>']
		]
	}),
	mode: 'local',
...
var minerRuleSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var minerRuleSearchWindow = new Ext.Window({
	title: '<?php __('Search MinerRule'); ?>',
	modal: true,
	items: minerRuleSearchForm,
	resizable: false,
	width: 550,
	height: 400,

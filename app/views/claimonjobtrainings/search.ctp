...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Claimonjobtraining.name', '<?php __('Name'); ?>']
,			['Claimonjobtraining.branch', '<?php __('Branch'); ?>']
,			['Claimonjobtraining.position', '<?php __('Position'); ?>']
,			['Claimonjobtraining.date_of_employment', '<?php __('Date Of Employment'); ?>']
,			['Claimonjobtraining.placement_date', '<?php __('Placement Date'); ?>']
,			['Claimonjobtraining.date_responded', '<?php __('Date Responded'); ?>']
,			['Claimonjobtraining.no_of_days', '<?php __('No Of Days'); ?>']
,			['Claimonjobtraining.payment_month', '<?php __('Payment Month'); ?>']
,			['Claimonjobtraining.placement_branch', '<?php __('Placement Branch'); ?>']
,			['Claimonjobtraining.basic_salary', '<?php __('Basic Salary'); ?>']
,			['Claimonjobtraining.transport', '<?php __('Transport'); ?>']
,			['Claimonjobtraining.hardship', '<?php __('Hardship'); ?>']
,			['Claimonjobtraining.pension', '<?php __('Pension'); ?>']
,			['Claimonjobtraining.total', '<?php __('Total'); ?>']
		]
	}),
	mode: 'local',
...
var claimonjobtrainingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					claimonjobtrainingSearchWindow.close();
...
var claimonjobtrainingSearchWindow = new Ext.Window({
	title: '<?php __('Search Claimonjobtraining'); ?>',
	modal: true,
	items: claimonjobtrainingSearchForm,
	resizable: false,
	width: 550,
	height: 400,

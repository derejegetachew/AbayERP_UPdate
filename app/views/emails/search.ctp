...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Email.name', '<?php __('Name'); ?>']
,			['Email.from_name', '<?php __('From Name'); ?>']
,			['Email.from', '<?php __('From'); ?>']
,			['Email.to', '<?php __('To'); ?>']
,			['Email.body', '<?php __('Body'); ?>']
,			['Email.status', '<?php __('Status'); ?>']
		]
	}),
	mode: 'local',
...
var emailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var emailSearchWindow = new Ext.Window({
	title: '<?php __('Search Email'); ?>',
	modal: true,
	items: emailSearchForm,
	resizable: false,
	width: 550,
	height: 400,

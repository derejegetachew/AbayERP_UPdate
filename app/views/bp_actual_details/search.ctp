...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['BpActualDetail.GLCode', '<?php __('GLCode'); ?>']
,			['BpActualDetail.GLDescription', '<?php __('GLDescription'); ?>']
,			['BpActualDetail.TDate', '<?php __('TDate'); ?>']
,			['BpActualDetail.VDate', '<?php __('VDate'); ?>']
,			['BpActualDetail.RefNo', '<?php __('RefNo'); ?>']
,			['BpActualDetail.CCY', '<?php __('CCY'); ?>']
,			['BpActualDetail.DR', '<?php __('DR'); ?>']
,			['BpActualDetail.CR', '<?php __('CR'); ?>']
,			['BpActualDetail.TranCode', '<?php __('TranCode'); ?>']
,			['BpActualDetail.TranDesc', '<?php __('TranDesc'); ?>']
,			['BpActualDetail.Amount', '<?php __('Amount'); ?>']
,			['BpActualDetail.InstrumentCode', '<?php __('InstrumentCode'); ?>']
,			['BpActualDetail.CPO', '<?php __('CPO'); ?>']
,			['BpActualDetail.Description', '<?php __('Description'); ?>']
		]
	}),
	mode: 'local',
...
var bpActualDetailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					bpActualDetailSearchWindow.close();
...
var bpActualDetailSearchWindow = new Ext.Window({
	title: '<?php __('Search BpActualDetail'); ?>',
	modal: true,
	items: bpActualDetailSearchForm,
	resizable: false,
	width: 550,
	height: 400,

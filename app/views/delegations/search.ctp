...
,			['Delegation.delegated', '<?php __('Delegated'); ?>']
,			['Delegation.start', '<?php __('Start'); ?>']
,			['Delegation.end', '<?php __('End'); ?>']
,			['Delegation.comment', '<?php __('Comment'); ?>']
,			['Delegation.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var delegationSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var delegationSearchWindow = new Ext.Window({
	title: '<?php __('Search Delegation'); ?>',
	modal: true,
	items: delegationSearchForm,
	resizable: false,
	width: 550,
	height: 400,

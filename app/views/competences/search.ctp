...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Competence.name', '<?php __('Name'); ?>']
,			['Competence.definition', '<?php __('Definition'); ?>']
,			['CompetenceCategory.name', '<?php __('CompetenceCategory'); ?>']
		]
	}),
	mode: 'local',
...
var competenceSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var competenceSearchWindow = new Ext.Window({
	title: '<?php __('Search Competence'); ?>',
	modal: true,
	items: competenceSearchForm,
	resizable: false,
	width: 550,
	height: 400,

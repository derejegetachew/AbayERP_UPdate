...
,			['Composition.count', '<?php __('Count'); ?>']
,			['Composition.created', '<?php __('Created'); ?>']
,			['Composition.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var compositionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var compositionSearchWindow = new Ext.Window({
	title: '<?php __('Search Composition'); ?>',
	modal: true,
	items: compositionSearchForm,
	resizable: false,
	width: 550,
	height: 400,

...
class SuppliersController extends AppController {
	...
	function list_data($id = null) {
		...
		$this->set('suppliers', $this->Supplier->find('all', array('conditions' => $conditions, 'limit' => $limit, 'offset' => $start)));
		$this->set('results', $this->Supplier->find('count', array('conditions' => $conditions)));
	}
